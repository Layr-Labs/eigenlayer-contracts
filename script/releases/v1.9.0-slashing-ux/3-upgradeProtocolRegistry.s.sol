...
contract UpgradeProtocolRegistry is DeployProtocolRegistryImpl {
    ...
    function testScript() public virtual override {
        ...
        // We don't need to test the  constructor since the `ProtocolRegistry` has no constructor with params and the
        // `AllocationManagerView` has not been deployed yet

        // We don't use the global function below since the `AllocationManagerView` has not been deployed yet
