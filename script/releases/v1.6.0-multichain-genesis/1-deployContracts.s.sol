...
contract DeployDestinationGenesis is EOADeployer {
    ...
    function _runAsEOA() internal override {
        ...
        opsMultisigInitialOwners = _getMultisigOwner("script/releases/1.6.0-multichain-genesis/opsOwners.toml");

        // Setup pauser multisig initial owners
        address[] memory pauserMultisigInitialOwners;
        pauserMultisigInitialOwners = _getMultisigOwner("script/releases/1.6.0-multichain-genesis/pauserOwners.toml");
