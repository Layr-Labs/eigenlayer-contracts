...
import {ITransparentUpgradeableProxy} from "zeus-templates/interfaces/ITransparentUpgradeableProxy.sol";
    ...
    function upgradeAndInitializeEmissionsController(
        ...
        return calls.append({
            ...
            data: abi.encodeCall(
                ...
                (
                    ITransparentUpgradeableProxy(address(Env.proxy.emissionsController())),
