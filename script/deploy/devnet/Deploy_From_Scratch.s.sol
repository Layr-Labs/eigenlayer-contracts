...
contract DeployFromScratch is ExistingDeploymentParser {
    function run(string memory configFilename, string memory outputFilename) external virtual {
        _parseInitialDeploymentParams(configFilename);
        ...
        logAndOutputContractAddresses(outputFilename);
    }
