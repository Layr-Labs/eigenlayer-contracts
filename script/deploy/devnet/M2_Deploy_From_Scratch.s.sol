...
contract Deployer_M2 is Script, Test {
    ...
    uint32 REWARDS_COORDINATOR_PERFORMANCE_GENESIS_REWARDS_TIMESTAMP;
    uint32 REWARDS_COORDINATOR_PERFORMANCE_MAX_RETROACTIVE_LENGTH;
    ...
    function run(string memory configFileName) external {
        ...
        REWARDS_COORDINATOR_PERFORMANCE_GENESIS_REWARDS_TIMESTAMP = uint32(
            stdJson.readUint(config_data, ".rewardsCoordinator.PERFORMANCE_GENESIS_REWARDS_TIMESTAMP")
        );
        REWARDS_COORDINATOR_PERFORMANCE_MAX_RETROACTIVE_LENGTH = uint32(
            stdJson.readUint(config_data, ".rewardsCoordinator.PERFORMANCE_MAX_RETROACTIVE_LENGTH")
        );
        ...
        rewardsCoordinatorImplementation = new RewardsCoordinator(
            ...
            REWARDS_COORDINATOR_PERFORMANCE_GENESIS_REWARDS_TIMESTAMP,
            REWARDS_COORDINATOR_PERFORMANCE_MAX_RETROACTIVE_LENGTH
        );
