...
contract Queue_M2_Upgrade is M2_Mainnet_Upgrade, TimelockEncoding {
    ...
    uint256 timelockEta = 1_712_559_600;
    ...
    function test_queueUpgrade() external {
        ...
        txs[5] = Tx(
            ...
            0,
            abi.encodeWithSelector(UpgradeableBeacon.upgradeTo.selector, eigenPodImplementation)
        );
        ...
        txs[6] = Tx(
            ...
            0, // value
            abi.encodeWithSelector(
                DelegationManager.setMinWithdrawalDelayBlocks.selector, DELEGATION_MANAGER_MIN_WITHDRAWAL_DELAY_BLOCKS
            )
        );
    ...
    function _postUpgradeChecks() internal {
        ...
        strategyManager.depositIntoStrategy({strategy: IStrategy(rETH_Strategy), token: IERC20(rETH), amount: amount});
        ...
        existingEigenPod.verifyWithdrawalCredentials(
            uint64(block.timestamp), stateRootProof, validatorIndices, validatorFieldsProofs, validatorFields
        );
    }
