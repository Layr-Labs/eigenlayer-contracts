...
contract ExistingDeploymentParser is Script, Test {
    ...
    function _parseInitialDeploymentParams(string memory initialDeploymentParamsPath) internal virtual {
        ...
        REWARDS_COORDINATOR_OPERATOR_SET_GENESIS_REWARDS_TIMESTAMP = uint32(
            stdJson.readUint(initialDeploymentData, ".rewardsCoordinator.REWARDS_COORDINATOR_OPERATOR_SET_GENESIS_REWARDS_TIMESTAMP")
        );
        REWARDS_COORDINATOR_OPERATOR_SET_MAX_RETROACTIVE_LENGTH = uint32(
            stdJson.readUint(initialDeploymentData, ".rewardsCoordinator.REWARDS_COORDINATOR_OPERATOR_SET_MAX_RETROACTIVE_LENGTH")
        );
        // AVSDirectory
