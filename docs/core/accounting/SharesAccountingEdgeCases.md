...
If an operator has *their own* Native ETH shares in EigenLayer and is fully slashed by an AVS, new deposits are not recoverable. Stakers can undelegate from the fully slashed operator, but an operator cannot undelegate from itself. 
