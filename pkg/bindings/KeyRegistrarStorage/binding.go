...
func (_KeyRegistrarStorage *KeyRegistrarStorageCaller) CheckKey(opts *bind.CallOpts, operatorSet OperatorSet, operator common.Address) (bool, error) {
	var out []interface{}
	err := _KeyRegistrarStorage.contract.Call(opts, &out, "checkKey", operatorSet, operator)
...
//
// Solidity: function checkKey((address,uint32) operatorSet, address operator) view returns(bool)
func (_KeyRegistrarStorage *KeyRegistrarStorageSession) CheckKey(operatorSet OperatorSet, operator common.Address) (bool, error) {
	return _KeyRegistrarStorage.Contract.CheckKey(&_KeyRegistrarStorage.CallOpts, operatorSet, operator)
}

// CheckKey is a free data retrieval call binding the contract method 0x0a6ac264.
//
// Solidity: function checkKey((address,uint32) operatorSet, address operator) view returns(bool)
func (_KeyRegistrarStorage *KeyRegistrarStorageCallerSession) CheckKey(operatorSet OperatorSet, operator common.Address) (bool, error) {
	return _KeyRegistrarStorage.Contract.CheckKey(&_KeyRegistrarStorage.CallOpts, operatorSet, operator)
}
