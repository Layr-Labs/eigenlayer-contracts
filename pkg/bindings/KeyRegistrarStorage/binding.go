...
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactor) ConfigureOperatorSetWithMinDelay(opts *bind.TransactOpts, operatorSet OperatorSet, curveType uint8, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.contract.Transact(opts, "configureOperatorSetWithMinDelay", operatorSet, curveType, minDelaySeconds)
}

// ConfigureOperatorSetWithMinDelay is a paid mutator transaction binding the contract method 0xa2d701f6.
//
// Solidity: function configureOperatorSetWithMinDelay((address,uint32) operatorSet, uint8 curveType, uint64 minDelaySeconds) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageSession) ConfigureOperatorSetWithMinDelay(operatorSet OperatorSet, curveType uint8, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.ConfigureOperatorSetWithMinDelay(&_KeyRegistrarStorage.TransactOpts, operatorSet, curveType, minDelaySeconds)
}

// ConfigureOperatorSetWithMinDelay is a paid mutator transaction binding the contract method 0xa2d701f6.
//
// Solidity: function configureOperatorSetWithMinDelay((address,uint32) operatorSet, uint8 curveType, uint64 minDelaySeconds) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactorSession) ConfigureOperatorSetWithMinDelay(operatorSet OperatorSet, curveType uint8, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.ConfigureOperatorSetWithMinDelay(&_KeyRegistrarStorage.TransactOpts, operatorSet, curveType, minDelaySeconds)
}
...
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactor) FinalizeScheduledRotation(opts *bind.TransactOpts, operator common.Address, operatorSet OperatorSet) (*types.Transaction, error) {
	return _KeyRegistrarStorage.contract.Transact(opts, "finalizeScheduledRotation", operator, operatorSet)
}

// FinalizeScheduledRotation is a paid mutator transaction binding the contract method 0x0934d597.
//
// Solidity: function finalizeScheduledRotation(address operator, (address,uint32) operatorSet) returns(bool success)
func (_KeyRegistrarStorage *KeyRegistrarStorageSession) FinalizeScheduledRotation(operator common.Address, operatorSet OperatorSet) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.FinalizeScheduledRotation(&_KeyRegistrarStorage.TransactOpts, operator, operatorSet)
}

// FinalizeScheduledRotation is a paid mutator transaction binding the contract method 0x0934d597.
//
// Solidity: function finalizeScheduledRotation(address operator, (address,uint32) operatorSet) returns(bool success)
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactorSession) FinalizeScheduledRotation(operator common.Address, operatorSet OperatorSet) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.FinalizeScheduledRotation(&_KeyRegistrarStorage.TransactOpts, operator, operatorSet)
}
...
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactor) RotateKey(opts *bind.TransactOpts, operator common.Address, operatorSet OperatorSet, newPubkey []byte, signature []byte) (*types.Transaction, error) {
	return _KeyRegistrarStorage.contract.Transact(opts, "rotateKey", operator, operatorSet, newPubkey, signature)
}

// RotateKey is a paid mutator transaction binding the contract method 0x81b2796c.
//
// Solidity: function rotateKey(address operator, (address,uint32) operatorSet, bytes newPubkey, bytes signature) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageSession) RotateKey(operator common.Address, operatorSet OperatorSet, newPubkey []byte, signature []byte) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.RotateKey(&_KeyRegistrarStorage.TransactOpts, operator, operatorSet, newPubkey, signature)
}

// RotateKey is a paid mutator transaction binding the contract method 0x81b2796c.
//
// Solidity: function rotateKey(address operator, (address,uint32) operatorSet, bytes newPubkey, bytes signature) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactorSession) RotateKey(operator common.Address, operatorSet OperatorSet, newPubkey []byte, signature []byte) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.RotateKey(&_KeyRegistrarStorage.TransactOpts, operator, operatorSet, newPubkey, signature)
}
...
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactor) SetMinKeyRotationDelay(opts *bind.TransactOpts, operatorSet OperatorSet, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.contract.Transact(opts, "setMinKeyRotationDelay", operatorSet, minDelaySeconds)
}

// SetMinKeyRotationDelay is a paid mutator transaction binding the contract method 0x11030402.
//
// Solidity: function setMinKeyRotationDelay((address,uint32) operatorSet, uint64 minDelaySeconds) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageSession) SetMinKeyRotationDelay(operatorSet OperatorSet, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.SetMinKeyRotationDelay(&_KeyRegistrarStorage.TransactOpts, operatorSet, minDelaySeconds)
}

// SetMinKeyRotationDelay is a paid mutator transaction binding the contract method 0x11030402.
//
// Solidity: function setMinKeyRotationDelay((address,uint32) operatorSet, uint64 minDelaySeconds) returns()
func (_KeyRegistrarStorage *KeyRegistrarStorageTransactorSession) SetMinKeyRotationDelay(operatorSet OperatorSet, minDelaySeconds uint64) (*types.Transaction, error) {
	return _KeyRegistrarStorage.Contract.SetMinKeyRotationDelay(&_KeyRegistrarStorage.TransactOpts, operatorSet, minDelaySeconds)
}
...
// KeyRegistrarStorageKeyRotationScheduledIterator is returned from FilterKeyRotationScheduled and is used to iterate over the raw logs and unpacked data for KeyRotationScheduled events raised by the KeyRegistrarStorage contract.
type KeyRegistrarStorageKeyRotationScheduledIterator struct {
	Event *KeyRegistrarStorageKeyRotationScheduled // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *KeyRegistrarStorageKeyRotationScheduledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(KeyRegistrarStorageKeyRotationScheduled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *KeyRegistrarStorageKeyRotationScheduledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *KeyRegistrarStorageKeyRotationScheduledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// KeyRegistrarStorageKeyRotationScheduled represents a KeyRotationScheduled event raised by the KeyRegistrarStorage contract.
type KeyRegistrarStorageKeyRotationScheduled struct {
	OperatorSet OperatorSet
	Operator    common.Address
	CurveType   uint8
	OldPubkey   []byte
...
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) FilterKeyRotationScheduled(opts *bind.FilterOpts, operator []common.Address) (*KeyRegistrarStorageKeyRotationScheduledIterator, error) {
	...
	logs, sub, err := _KeyRegistrarStorage.contract.FilterLogs(opts, "KeyRotationScheduled", operatorRule)
	if err != nil {
		return nil, err
	}
	return &KeyRegistrarStorageKeyRotationScheduledIterator{contract: _KeyRegistrarStorage.contract, event: "KeyRotationScheduled", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event KeyRotationScheduled((address,uint32) operatorSet, address indexed operator, uint8 curveType, bytes oldPubkey, bytes newPubkey, uint64 activateAt)
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) WatchKeyRotationScheduled(opts *bind.WatchOpts, sink chan<- *KeyRegistrarStorageKeyRotationScheduled, operator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _KeyRegistrarStorage.contract.WatchLogs(opts, "KeyRotationScheduled", operatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(KeyRegistrarStorageKeyRotationScheduled)
				if err := _KeyRegistrarStorage.contract.UnpackLog(event, "KeyRotationScheduled", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event KeyRotationScheduled((address,uint32) operatorSet, address indexed operator, uint8 curveType, bytes oldPubkey, bytes newPubkey, uint64 activateAt)
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) ParseKeyRotationScheduled(log types.Log) (*KeyRegistrarStorageKeyRotationScheduled, error) {
	event := new(KeyRegistrarStorageKeyRotationScheduled)
	if err := _KeyRegistrarStorage.contract.UnpackLog(event, "KeyRotationScheduled", log); err != nil {
		return nil, err
	}
...
// KeyRegistrarStorageMinKeyRotationDelaySetIterator is returned from FilterMinKeyRotationDelaySet and is used to iterate over the raw logs and unpacked data for MinKeyRotationDelaySet events raised by the KeyRegistrarStorage contract.
type KeyRegistrarStorageMinKeyRotationDelaySetIterator struct {
	Event *KeyRegistrarStorageMinKeyRotationDelaySet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *KeyRegistrarStorageMinKeyRotationDelaySetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(KeyRegistrarStorageMinKeyRotationDelaySet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *KeyRegistrarStorageMinKeyRotationDelaySetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *KeyRegistrarStorageMinKeyRotationDelaySetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// KeyRegistrarStorageMinKeyRotationDelaySet represents a MinKeyRotationDelaySet event raised by the KeyRegistrarStorage contract.
type KeyRegistrarStorageMinKeyRotationDelaySet struct {
	OperatorSet OperatorSet
	MinDelay    uint64
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) FilterMinKeyRotationDelaySet(opts *bind.FilterOpts) (*KeyRegistrarStorageMinKeyRotationDelaySetIterator, error) {

	logs, sub, err := _KeyRegistrarStorage.contract.FilterLogs(opts, "MinKeyRotationDelaySet")
	if err != nil {
		return nil, err
	}
	return &KeyRegistrarStorageMinKeyRotationDelaySetIterator{contract: _KeyRegistrarStorage.contract, event: "MinKeyRotationDelaySet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MinKeyRotationDelaySet((address,uint32) operatorSet, uint64 minDelay)
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) WatchMinKeyRotationDelaySet(opts *bind.WatchOpts, sink chan<- *KeyRegistrarStorageMinKeyRotationDelaySet) (event.Subscription, error) {

	logs, sub, err := _KeyRegistrarStorage.contract.WatchLogs(opts, "MinKeyRotationDelaySet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(KeyRegistrarStorageMinKeyRotationDelaySet)
				if err := _KeyRegistrarStorage.contract.UnpackLog(event, "MinKeyRotationDelaySet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MinKeyRotationDelaySet((address,uint32) operatorSet, uint64 minDelay)
func (_KeyRegistrarStorage *KeyRegistrarStorageFilterer) ParseMinKeyRotationDelaySet(log types.Log) (*KeyRegistrarStorageMinKeyRotationDelaySet, error) {
	event := new(KeyRegistrarStorageMinKeyRotationDelaySet)
	if err := _KeyRegistrarStorage.contract.UnpackLog(event, "MinKeyRotationDelaySet", log); err != nil {
		return nil, err
	}
