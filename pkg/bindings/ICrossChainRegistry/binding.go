...
func (_ICrossChainRegistry *ICrossChainRegistryCaller) HasActiveGenerationReservation(opts *bind.CallOpts, operatorSet OperatorSet) (bool, error) {
	var out []interface{}
	err := _ICrossChainRegistry.contract.Call(opts, &out, "hasActiveGenerationReservation", operatorSet)
...
//
// Solidity: function hasActiveGenerationReservation((address,uint32) operatorSet) view returns(bool)
func (_ICrossChainRegistry *ICrossChainRegistrySession) HasActiveGenerationReservation(operatorSet OperatorSet) (bool, error) {
	return _ICrossChainRegistry.Contract.HasActiveGenerationReservation(&_ICrossChainRegistry.CallOpts, operatorSet)
}

// HasActiveGenerationReservation is a free data retrieval call binding the contract method 0x36b200de.
//
// Solidity: function hasActiveGenerationReservation((address,uint32) operatorSet) view returns(bool)
func (_ICrossChainRegistry *ICrossChainRegistryCallerSession) HasActiveGenerationReservation(operatorSet OperatorSet) (bool, error) {
	return _ICrossChainRegistry.Contract.HasActiveGenerationReservation(&_ICrossChainRegistry.CallOpts, operatorSet)
}
