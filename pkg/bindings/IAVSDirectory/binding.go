...
func (_IAVSDirectory *IAVSDirectoryCaller) GetSlashableBips(opts *bind.CallOpts, operator common.Address, operatorSet IAVSDirectoryOperatorSet, strategy common.Address, timestamp uint32) (uint16, error) {
	var out []interface{}
	err := _IAVSDirectory.contract.Call(opts, &out, "getSlashableBips", operator, operatorSet, strategy, timestamp)
...
//
// Solidity: function getSlashableBips(address operator, (address,uint32) operatorSet, address strategy, uint32 timestamp) view returns(uint16)
func (_IAVSDirectory *IAVSDirectorySession) GetSlashableBips(operator common.Address, operatorSet IAVSDirectoryOperatorSet, strategy common.Address, timestamp uint32) (uint16, error) {
...
func (_IAVSDirectory *IAVSDirectoryTransactor) Allocate(opts *bind.TransactOpts, operator common.Address, allocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.contract.Transact(opts, "allocate", operator, allocations, operatorSignature)
}

// Allocate is a paid mutator transaction binding the contract method 0x70196708.
//
// Solidity: function allocate(address operator, (address,(address,uint32)[],uint64[])[] allocations, (bytes,bytes32,uint256) operatorSignature) returns()
func (_IAVSDirectory *IAVSDirectorySession) Allocate(operator common.Address, allocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.Allocate(&_IAVSDirectory.TransactOpts, operator, allocations, operatorSignature)
}

// Allocate is a paid mutator transaction binding the contract method 0x70196708.
//
// Solidity: function allocate(address operator, (address,(address,uint32)[],uint64[])[] allocations, (bytes,bytes32,uint256) operatorSignature) returns()
func (_IAVSDirectory *IAVSDirectoryTransactorSession) Allocate(operator common.Address, allocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.Allocate(&_IAVSDirectory.TransactOpts, operator, allocations, operatorSignature)
}
...
func (_IAVSDirectory *IAVSDirectoryTransactor) CompleteDeallocations(opts *bind.TransactOpts, operator common.Address, strategies []common.Address, operatorSets [][]IAVSDirectoryOperatorSet) (*types.Transaction, error) {
	return _IAVSDirectory.contract.Transact(opts, "completeDeallocations", operator, strategies, operatorSets)
}

// CompleteDeallocations is a paid mutator transaction binding the contract method 0x5a922613.
//
// Solidity: function completeDeallocations(address operator, address[] strategies, (address,uint32)[][] operatorSets) returns()
func (_IAVSDirectory *IAVSDirectorySession) CompleteDeallocations(operator common.Address, strategies []common.Address, operatorSets [][]IAVSDirectoryOperatorSet) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.CompleteDeallocations(&_IAVSDirectory.TransactOpts, operator, strategies, operatorSets)
}

// CompleteDeallocations is a paid mutator transaction binding the contract method 0x5a922613.
//
// Solidity: function completeDeallocations(address operator, address[] strategies, (address,uint32)[][] operatorSets) returns()
func (_IAVSDirectory *IAVSDirectoryTransactorSession) CompleteDeallocations(operator common.Address, strategies []common.Address, operatorSets [][]IAVSDirectoryOperatorSet) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.CompleteDeallocations(&_IAVSDirectory.TransactOpts, operator, strategies, operatorSets)
}
...
func (_IAVSDirectory *IAVSDirectoryTransactor) QueueDeallocate(opts *bind.TransactOpts, operator common.Address, deallocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.contract.Transact(opts, "queueDeallocate", operator, deallocations, operatorSignature)
}

// QueueDeallocate is a paid mutator transaction binding the contract method 0x4ef8c5d4.
//
// Solidity: function queueDeallocate(address operator, (address,(address,uint32)[],uint64[])[] deallocations, (bytes,bytes32,uint256) operatorSignature) returns()
func (_IAVSDirectory *IAVSDirectorySession) QueueDeallocate(operator common.Address, deallocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.QueueDeallocate(&_IAVSDirectory.TransactOpts, operator, deallocations, operatorSignature)
}

// QueueDeallocate is a paid mutator transaction binding the contract method 0x4ef8c5d4.
//
// Solidity: function queueDeallocate(address operator, (address,(address,uint32)[],uint64[])[] deallocations, (bytes,bytes32,uint256) operatorSignature) returns()
func (_IAVSDirectory *IAVSDirectoryTransactorSession) QueueDeallocate(operator common.Address, deallocations []IAVSDirectoryMagnitudeAdjustment, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.QueueDeallocate(&_IAVSDirectory.TransactOpts, operator, deallocations, operatorSignature)
}
