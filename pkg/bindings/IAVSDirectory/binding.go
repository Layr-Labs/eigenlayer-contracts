...
func (_IAVSDirectory *IAVSDirectoryTransactor) DeregisterFromAVSOperatorSets(opts *bind.TransactOpts, avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _IAVSDirectory.contract.Transact(opts, "deregisterFromAVSOperatorSets", avs, operatorSetIds)
}

// DeregisterFromAVSOperatorSets is a paid mutator transaction binding the contract method 0x9c6c5184.
//
// Solidity: function deregisterFromAVSOperatorSets(address avs, uint32[] operatorSetIds) returns()
func (_IAVSDirectory *IAVSDirectorySession) DeregisterFromAVSOperatorSets(avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.DeregisterFromAVSOperatorSets(&_IAVSDirectory.TransactOpts, avs, operatorSetIds)
}

// DeregisterFromAVSOperatorSets is a paid mutator transaction binding the contract method 0x9c6c5184.
//
// Solidity: function deregisterFromAVSOperatorSets(address avs, uint32[] operatorSetIds) returns()
func (_IAVSDirectory *IAVSDirectoryTransactorSession) DeregisterFromAVSOperatorSets(avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _IAVSDirectory.Contract.DeregisterFromAVSOperatorSets(&_IAVSDirectory.TransactOpts, avs, operatorSetIds)
}
