...
// IAVSDirectoryOperatorSetStrategyAddedIterator is returned from FilterOperatorSetStrategyAdded and is used to iterate over the raw logs and unpacked data for OperatorSetStrategyAdded events raised by the IAVSDirectory contract.
type IAVSDirectoryOperatorSetStrategyAddedIterator struct {
	Event *IAVSDirectoryOperatorSetStrategyAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAVSDirectoryOperatorSetStrategyAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAVSDirectoryOperatorSetStrategyAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAVSDirectoryOperatorSetStrategyAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAVSDirectoryOperatorSetStrategyAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IAVSDirectoryOperatorSetStrategyAdded represents a OperatorSetStrategyAdded event raised by the IAVSDirectory contract.
type IAVSDirectoryOperatorSetStrategyAdded struct {
	OperatorSet IAVSDirectoryOperatorSet
...
func (_IAVSDirectory *IAVSDirectoryFilterer) FilterOperatorSetStrategyAdded(opts *bind.FilterOpts) (*IAVSDirectoryOperatorSetStrategyAddedIterator, error) {

	logs, sub, err := _IAVSDirectory.contract.FilterLogs(opts, "OperatorSetStrategyAdded")
	if err != nil {
		return nil, err
	}
	return &IAVSDirectoryOperatorSetStrategyAddedIterator{contract: _IAVSDirectory.contract, event: "OperatorSetStrategyAdded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event OperatorSetStrategyAdded((address,uint32) operatorSet, address strategy)
func (_IAVSDirectory *IAVSDirectoryFilterer) WatchOperatorSetStrategyAdded(opts *bind.WatchOpts, sink chan<- *IAVSDirectoryOperatorSetStrategyAdded) (event.Subscription, error) {

	logs, sub, err := _IAVSDirectory.contract.WatchLogs(opts, "OperatorSetStrategyAdded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAVSDirectoryOperatorSetStrategyAdded)
				if err := _IAVSDirectory.contract.UnpackLog(event, "OperatorSetStrategyAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OperatorSetStrategyAdded((address,uint32) operatorSet, address strategy)
func (_IAVSDirectory *IAVSDirectoryFilterer) ParseOperatorSetStrategyAdded(log types.Log) (*IAVSDirectoryOperatorSetStrategyAdded, error) {
	event := new(IAVSDirectoryOperatorSetStrategyAdded)
	if err := _IAVSDirectory.contract.UnpackLog(event, "OperatorSetStrategyAdded", log); err != nil {
		return nil, err
	}
...
// IAVSDirectoryOperatorSetStrategyRemovedIterator is returned from FilterOperatorSetStrategyRemoved and is used to iterate over the raw logs and unpacked data for OperatorSetStrategyRemoved events raised by the IAVSDirectory contract.
type IAVSDirectoryOperatorSetStrategyRemovedIterator struct {
	Event *IAVSDirectoryOperatorSetStrategyRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAVSDirectoryOperatorSetStrategyRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAVSDirectoryOperatorSetStrategyRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAVSDirectoryOperatorSetStrategyRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAVSDirectoryOperatorSetStrategyRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IAVSDirectoryOperatorSetStrategyRemoved represents a OperatorSetStrategyRemoved event raised by the IAVSDirectory contract.
type IAVSDirectoryOperatorSetStrategyRemoved struct {
	OperatorSet IAVSDirectoryOperatorSet
	Strategy    common.Address
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_IAVSDirectory *IAVSDirectoryFilterer) FilterOperatorSetStrategyRemoved(opts *bind.FilterOpts) (*IAVSDirectoryOperatorSetStrategyRemovedIterator, error) {

	logs, sub, err := _IAVSDirectory.contract.FilterLogs(opts, "OperatorSetStrategyRemoved")
	if err != nil {
		return nil, err
	}
	return &IAVSDirectoryOperatorSetStrategyRemovedIterator{contract: _IAVSDirectory.contract, event: "OperatorSetStrategyRemoved", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event OperatorSetStrategyRemoved((address,uint32) operatorSet, address strategy)
func (_IAVSDirectory *IAVSDirectoryFilterer) WatchOperatorSetStrategyRemoved(opts *bind.WatchOpts, sink chan<- *IAVSDirectoryOperatorSetStrategyRemoved) (event.Subscription, error) {

	logs, sub, err := _IAVSDirectory.contract.WatchLogs(opts, "OperatorSetStrategyRemoved")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAVSDirectoryOperatorSetStrategyRemoved)
				if err := _IAVSDirectory.contract.UnpackLog(event, "OperatorSetStrategyRemoved", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OperatorSetStrategyRemoved((address,uint32) operatorSet, address strategy)
func (_IAVSDirectory *IAVSDirectoryFilterer) ParseOperatorSetStrategyRemoved(log types.Log) (*IAVSDirectoryOperatorSetStrategyRemoved, error) {
	event := new(IAVSDirectoryOperatorSetStrategyRemoved)
	if err := _IAVSDirectory.contract.UnpackLog(event, "OperatorSetStrategyRemoved", log); err != nil {
		return nil, err
	}
