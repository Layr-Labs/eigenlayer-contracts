...
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactor) SetGenerator(opts *bind.TransactOpts, operatorSet OperatorSet) (*types.Transaction, error) {
	return _IOperatorTableUpdater.contract.Transact(opts, "setGenerator", operatorSet)
}

// SetGenerator is a paid mutator transaction binding the contract method 0x77d90e94.
//
// Solidity: function setGenerator((address,uint32) operatorSet) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterSession) SetGenerator(operatorSet OperatorSet) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.SetGenerator(&_IOperatorTableUpdater.TransactOpts, operatorSet)
}

// SetGenerator is a paid mutator transaction binding the contract method 0x77d90e94.
//
// Solidity: function setGenerator((address,uint32) operatorSet) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactorSession) SetGenerator(operatorSet OperatorSet) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.SetGenerator(&_IOperatorTableUpdater.TransactOpts, operatorSet)
}
...
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactor) UpdateGenerator(opts *bind.TransactOpts, referenceTimestamp uint32, GeneratorInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, GeneratorConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.contract.Transact(opts, "updateGenerator", referenceTimestamp, GeneratorInfo, GeneratorConfig)
}

// UpdateGenerator is a paid mutator transaction binding the contract method 0xe944e0a8.
//
// Solidity: function updateGenerator(uint32 referenceTimestamp, (bytes32,uint256,(uint256,uint256),uint256[]) GeneratorInfo, (address,uint32) GeneratorConfig) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterSession) UpdateGenerator(referenceTimestamp uint32, GeneratorInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, GeneratorConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.UpdateGenerator(&_IOperatorTableUpdater.TransactOpts, referenceTimestamp, GeneratorInfo, GeneratorConfig)
}

// UpdateGenerator is a paid mutator transaction binding the contract method 0xe944e0a8.
//
// Solidity: function updateGenerator(uint32 referenceTimestamp, (bytes32,uint256,(uint256,uint256),uint256[]) GeneratorInfo, (address,uint32) GeneratorConfig) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactorSession) UpdateGenerator(referenceTimestamp uint32, GeneratorInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, GeneratorConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.UpdateGenerator(&_IOperatorTableUpdater.TransactOpts, referenceTimestamp, GeneratorInfo, GeneratorConfig)
}
