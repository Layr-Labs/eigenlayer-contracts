...
func (_IOperatorTableUpdater *IOperatorTableUpdaterCaller) GetGlobalConfirmerSetReferenceTimestamp(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _IOperatorTableUpdater.contract.Call(opts, &out, "getGlobalConfirmerSetReferenceTimestamp")
...
//
// Solidity: function getGlobalConfirmerSetReferenceTimestamp() view returns(uint32)
func (_IOperatorTableUpdater *IOperatorTableUpdaterSession) GetGlobalConfirmerSetReferenceTimestamp() (uint32, error) {
	return _IOperatorTableUpdater.Contract.GetGlobalConfirmerSetReferenceTimestamp(&_IOperatorTableUpdater.CallOpts)
}

// GetGlobalConfirmerSetReferenceTimestamp is a free data retrieval call binding the contract method 0x0f3f8edd.
//
// Solidity: function getGlobalConfirmerSetReferenceTimestamp() view returns(uint32)
func (_IOperatorTableUpdater *IOperatorTableUpdaterCallerSession) GetGlobalConfirmerSetReferenceTimestamp() (uint32, error) {
	return _IOperatorTableUpdater.Contract.GetGlobalConfirmerSetReferenceTimestamp(&_IOperatorTableUpdater.CallOpts)
}
...
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactor) UpdateGlobalRootConfirmerSet(opts *bind.TransactOpts, referenceTimestamp uint32, globalRootConfirmerSetInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, globalRootConfirmerSetConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.contract.Transact(opts, "updateGlobalRootConfirmerSet", referenceTimestamp, globalRootConfirmerSetInfo, globalRootConfirmerSetConfig)
}

// UpdateGlobalRootConfirmerSet is a paid mutator transaction binding the contract method 0x1ab78d90.
//
// Solidity: function updateGlobalRootConfirmerSet(uint32 referenceTimestamp, (bytes32,uint256,(uint256,uint256),uint256[]) globalRootConfirmerSetInfo, (address,uint32) globalRootConfirmerSetConfig) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterSession) UpdateGlobalRootConfirmerSet(referenceTimestamp uint32, globalRootConfirmerSetInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, globalRootConfirmerSetConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.UpdateGlobalRootConfirmerSet(&_IOperatorTableUpdater.TransactOpts, referenceTimestamp, globalRootConfirmerSetInfo, globalRootConfirmerSetConfig)
}

// UpdateGlobalRootConfirmerSet is a paid mutator transaction binding the contract method 0x1ab78d90.
//
// Solidity: function updateGlobalRootConfirmerSet(uint32 referenceTimestamp, (bytes32,uint256,(uint256,uint256),uint256[]) globalRootConfirmerSetInfo, (address,uint32) globalRootConfirmerSetConfig) returns()
func (_IOperatorTableUpdater *IOperatorTableUpdaterTransactorSession) UpdateGlobalRootConfirmerSet(referenceTimestamp uint32, globalRootConfirmerSetInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, globalRootConfirmerSetConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _IOperatorTableUpdater.Contract.UpdateGlobalRootConfirmerSet(&_IOperatorTableUpdater.TransactOpts, referenceTimestamp, globalRootConfirmerSetInfo, globalRootConfirmerSetConfig)
}
