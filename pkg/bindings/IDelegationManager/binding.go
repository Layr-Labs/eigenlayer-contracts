...
func (_IDelegationManager *IDelegationManagerCaller) Allocator(opts *bind.CallOpts, operator common.Address) (common.Address, error) {
	var out []interface{}
	err := _IDelegationManager.contract.Call(opts, &out, "allocator", operator)
...
//
// Solidity: function allocator(address operator) view returns(address)
func (_IDelegationManager *IDelegationManagerSession) Allocator(operator common.Address) (common.Address, error) {
	return _IDelegationManager.Contract.Allocator(&_IDelegationManager.CallOpts, operator)
}

// Allocator is a free data retrieval call binding the contract method 0x69066d91.
//
// Solidity: function allocator(address operator) view returns(address)
func (_IDelegationManager *IDelegationManagerCallerSession) Allocator(operator common.Address) (common.Address, error) {
	return _IDelegationManager.Contract.Allocator(&_IDelegationManager.CallOpts, operator)
}
