...
func (_IDelegationManager *IDelegationManagerCaller) QueuedWithdrawals(opts *bind.CallOpts, withdrawalRoot [32]byte) (IDelegationManagerTypesWithdrawal, error) {
	var out []interface{}
	err := _IDelegationManager.contract.Call(opts, &out, "queuedWithdrawals", withdrawalRoot)
...
//
// Solidity: function queuedWithdrawals(bytes32 withdrawalRoot) view returns((address,address,address,uint256,uint32,address[],uint256[]) withdrawal)
func (_IDelegationManager *IDelegationManagerSession) QueuedWithdrawals(withdrawalRoot [32]byte) (IDelegationManagerTypesWithdrawal, error) {
	return _IDelegationManager.Contract.QueuedWithdrawals(&_IDelegationManager.CallOpts, withdrawalRoot)
}

// QueuedWithdrawals is a free data retrieval call binding the contract method 0x99f5371b.
//
// Solidity: function queuedWithdrawals(bytes32 withdrawalRoot) view returns((address,address,address,uint256,uint32,address[],uint256[]) withdrawal)
func (_IDelegationManager *IDelegationManagerCallerSession) QueuedWithdrawals(withdrawalRoot [32]byte) (IDelegationManagerTypesWithdrawal, error) {
	return _IDelegationManager.Contract.QueuedWithdrawals(&_IDelegationManager.CallOpts, withdrawalRoot)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) ClearQueuedWithdrawalsForDisabledPod(opts *bind.TransactOpts, staker common.Address) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "clearQueuedWithdrawalsForDisabledPod", staker)
}

// ClearQueuedWithdrawalsForDisabledPod is a paid mutator transaction binding the contract method 0x29681457.
//
// Solidity: function clearQueuedWithdrawalsForDisabledPod(address staker) returns()
func (_IDelegationManager *IDelegationManagerSession) ClearQueuedWithdrawalsForDisabledPod(staker common.Address) (*types.Transaction, error) {
	return _IDelegationManager.Contract.ClearQueuedWithdrawalsForDisabledPod(&_IDelegationManager.TransactOpts, staker)
}

// ClearQueuedWithdrawalsForDisabledPod is a paid mutator transaction binding the contract method 0x29681457.
//
// Solidity: function clearQueuedWithdrawalsForDisabledPod(address staker) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) ClearQueuedWithdrawalsForDisabledPod(staker common.Address) (*types.Transaction, error) {
	return _IDelegationManager.Contract.ClearQueuedWithdrawalsForDisabledPod(&_IDelegationManager.TransactOpts, staker)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) Initialize(opts *bind.TransactOpts, initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "initialize", initialPausedStatus)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialPausedStatus) returns()
func (_IDelegationManager *IDelegationManagerSession) Initialize(initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.Initialize(&_IDelegationManager.TransactOpts, initialPausedStatus)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialPausedStatus) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) Initialize(initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.Initialize(&_IDelegationManager.TransactOpts, initialPausedStatus)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) SlashOperatorShares(opts *bind.TransactOpts, operator common.Address, operatorSet OperatorSet, slashId *big.Int, strategy common.Address, prevMaxMagnitude uint64, newMaxMagnitude uint64) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "slashOperatorShares", operator, operatorSet, slashId, strategy, prevMaxMagnitude, newMaxMagnitude)
}

// SlashOperatorShares is a paid mutator transaction binding the contract method 0x5ae679a7.
//
// Solidity: function slashOperatorShares(address operator, (address,uint32) operatorSet, uint256 slashId, address strategy, uint64 prevMaxMagnitude, uint64 newMaxMagnitude) returns(uint256 totalDepositSharesToSlash)
func (_IDelegationManager *IDelegationManagerSession) SlashOperatorShares(operator common.Address, operatorSet OperatorSet, slashId *big.Int, strategy common.Address, prevMaxMagnitude uint64, newMaxMagnitude uint64) (*types.Transaction, error) {
	return _IDelegationManager.Contract.SlashOperatorShares(&_IDelegationManager.TransactOpts, operator, operatorSet, slashId, strategy, prevMaxMagnitude, newMaxMagnitude)
}

// SlashOperatorShares is a paid mutator transaction binding the contract method 0x5ae679a7.
//
// Solidity: function slashOperatorShares(address operator, (address,uint32) operatorSet, uint256 slashId, address strategy, uint64 prevMaxMagnitude, uint64 newMaxMagnitude) returns(uint256 totalDepositSharesToSlash)
func (_IDelegationManager *IDelegationManagerTransactorSession) SlashOperatorShares(operator common.Address, operatorSet OperatorSet, slashId *big.Int, strategy common.Address, prevMaxMagnitude uint64, newMaxMagnitude uint64) (*types.Transaction, error) {
	return _IDelegationManager.Contract.SlashOperatorShares(&_IDelegationManager.TransactOpts, operator, operatorSet, slashId, strategy, prevMaxMagnitude, newMaxMagnitude)
}
...
// IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator is returned from FilterQueuedWithdrawalClearedForDisabledPod and is used to iterate over the raw logs and unpacked data for QueuedWithdrawalClearedForDisabledPod events raised by the IDelegationManager contract.
type IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator struct {
	Event *IDelegationManagerQueuedWithdrawalClearedForDisabledPod // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IDelegationManagerQueuedWithdrawalClearedForDisabledPod)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IDelegationManagerQueuedWithdrawalClearedForDisabledPod represents a QueuedWithdrawalClearedForDisabledPod event raised by the IDelegationManager contract.
type IDelegationManagerQueuedWithdrawalClearedForDisabledPod struct {
...
func (_IDelegationManager *IDelegationManagerFilterer) FilterQueuedWithdrawalClearedForDisabledPod(opts *bind.FilterOpts, withdrawalRoot [][32]byte) (*IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator, error) {
	...
	logs, sub, err := _IDelegationManager.contract.FilterLogs(opts, "QueuedWithdrawalClearedForDisabledPod", withdrawalRootRule)
	if err != nil {
		return nil, err
	}
	return &IDelegationManagerQueuedWithdrawalClearedForDisabledPodIterator{contract: _IDelegationManager.contract, event: "QueuedWithdrawalClearedForDisabledPod", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event QueuedWithdrawalClearedForDisabledPod(bytes32 indexed withdrawalRoot)
func (_IDelegationManager *IDelegationManagerFilterer) WatchQueuedWithdrawalClearedForDisabledPod(opts *bind.WatchOpts, sink chan<- *IDelegationManagerQueuedWithdrawalClearedForDisabledPod, withdrawalRoot [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _IDelegationManager.contract.WatchLogs(opts, "QueuedWithdrawalClearedForDisabledPod", withdrawalRootRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IDelegationManagerQueuedWithdrawalClearedForDisabledPod)
				if err := _IDelegationManager.contract.UnpackLog(event, "QueuedWithdrawalClearedForDisabledPod", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event QueuedWithdrawalClearedForDisabledPod(bytes32 indexed withdrawalRoot)
func (_IDelegationManager *IDelegationManagerFilterer) ParseQueuedWithdrawalClearedForDisabledPod(log types.Log) (*IDelegationManagerQueuedWithdrawalClearedForDisabledPod, error) {
	event := new(IDelegationManagerQueuedWithdrawalClearedForDisabledPod)
	if err := _IDelegationManager.contract.UnpackLog(event, "QueuedWithdrawalClearedForDisabledPod", log); err != nil {
		return nil, err
	}
