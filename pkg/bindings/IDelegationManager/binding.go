...
func (_IDelegationManager *IDelegationManagerCaller) MINWITHDRAWALDELAYBLOCKS(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _IDelegationManager.contract.Call(opts, &out, "MIN_WITHDRAWAL_DELAY_BLOCKS")
...
func (_IDelegationManager *IDelegationManagerTransactor) CompleteQueuedWithdrawals(opts *bind.TransactOpts, tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "completeQueuedWithdrawals", tokens, receiveAsTokens, numToComplete)
}

// CompleteQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5f48e667.
//
// Solidity: function completeQueuedWithdrawals(address[][] tokens, bool[] receiveAsTokens, uint256 numToComplete) returns()
func (_IDelegationManager *IDelegationManagerSession) CompleteQueuedWithdrawals(tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.CompleteQueuedWithdrawals(&_IDelegationManager.TransactOpts, tokens, receiveAsTokens, numToComplete)
}

// CompleteQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5f48e667.
//
// Solidity: function completeQueuedWithdrawals(address[][] tokens, bool[] receiveAsTokens, uint256 numToComplete) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) CompleteQueuedWithdrawals(tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.CompleteQueuedWithdrawals(&_IDelegationManager.TransactOpts, tokens, receiveAsTokens, numToComplete)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) CompleteQueuedWithdrawals0(opts *bind.TransactOpts, withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "completeQueuedWithdrawals0", withdrawals, tokens, receiveAsTokens)
}

// CompleteQueuedWithdrawals0 is a paid mutator transaction binding the contract method 0x9435bb43.
//
// Solidity: function completeQueuedWithdrawals((address,address,address,uint256,uint32,address[],uint256[])[] withdrawals, address[][] tokens, bool[] receiveAsTokens) returns()
func (_IDelegationManager *IDelegationManagerSession) CompleteQueuedWithdrawals0(withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _IDelegationManager.Contract.CompleteQueuedWithdrawals0(&_IDelegationManager.TransactOpts, withdrawals, tokens, receiveAsTokens)
}

// CompleteQueuedWithdrawals0 is a paid mutator transaction binding the contract method 0x9435bb43.
//
// Solidity: function completeQueuedWithdrawals((address,address,address,uint256,uint32,address[],uint256[])[] withdrawals, address[][] tokens, bool[] receiveAsTokens) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) CompleteQueuedWithdrawals0(withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _IDelegationManager.Contract.CompleteQueuedWithdrawals0(&_IDelegationManager.TransactOpts, withdrawals, tokens, receiveAsTokens)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) DecreaseDelegatedShares(opts *bind.TransactOpts, staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "decreaseDelegatedShares", staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}

// DecreaseDelegatedShares is a paid mutator transaction binding the contract method 0x63ceb57d.
//
// Solidity: function decreaseDelegatedShares(address staker, uint256 curDepositShares, uint64 prevBeaconChainSlashingFactor, uint256 wadSlashed) returns()
func (_IDelegationManager *IDelegationManagerSession) DecreaseDelegatedShares(staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.DecreaseDelegatedShares(&_IDelegationManager.TransactOpts, staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}

// DecreaseDelegatedShares is a paid mutator transaction binding the contract method 0x63ceb57d.
//
// Solidity: function decreaseDelegatedShares(address staker, uint256 curDepositShares, uint64 prevBeaconChainSlashingFactor, uint256 wadSlashed) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) DecreaseDelegatedShares(staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _IDelegationManager.Contract.DecreaseDelegatedShares(&_IDelegationManager.TransactOpts, staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}
