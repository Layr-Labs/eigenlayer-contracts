...
func (_IDelegationManager *IDelegationManagerCaller) EarningsReceiver(opts *bind.CallOpts, operator common.Address) (common.Address, error) {
	var out []interface{}
	err := _IDelegationManager.contract.Call(opts, &out, "earningsReceiver", operator)
...
//
// Solidity: function earningsReceiver(address operator) view returns(address)
func (_IDelegationManager *IDelegationManagerSession) EarningsReceiver(operator common.Address) (common.Address, error) {
	return _IDelegationManager.Contract.EarningsReceiver(&_IDelegationManager.CallOpts, operator)
}

// EarningsReceiver is a free data retrieval call binding the contract method 0x5f966f14.
//
// Solidity: function earningsReceiver(address operator) view returns(address)
func (_IDelegationManager *IDelegationManagerCallerSession) EarningsReceiver(operator common.Address) (common.Address, error) {
	return _IDelegationManager.Contract.EarningsReceiver(&_IDelegationManager.CallOpts, operator)
}
...
func (_IDelegationManager *IDelegationManagerTransactor) MigrateQueuedWithdrawals(opts *bind.TransactOpts, withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _IDelegationManager.contract.Transact(opts, "migrateQueuedWithdrawals", withdrawalsToQueue)
}

// MigrateQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5cfe8d2c.
//
// Solidity: function migrateQueuedWithdrawals((address[],uint256[],address,(address,uint96),uint32,address)[] withdrawalsToQueue) returns()
func (_IDelegationManager *IDelegationManagerSession) MigrateQueuedWithdrawals(withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _IDelegationManager.Contract.MigrateQueuedWithdrawals(&_IDelegationManager.TransactOpts, withdrawalsToQueue)
}

// MigrateQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5cfe8d2c.
//
// Solidity: function migrateQueuedWithdrawals((address[],uint256[],address,(address,uint96),uint32,address)[] withdrawalsToQueue) returns()
func (_IDelegationManager *IDelegationManagerTransactorSession) MigrateQueuedWithdrawals(withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _IDelegationManager.Contract.MigrateQueuedWithdrawals(&_IDelegationManager.TransactOpts, withdrawalsToQueue)
}
...
// IDelegationManagerWithdrawalMigratedIterator is returned from FilterWithdrawalMigrated and is used to iterate over the raw logs and unpacked data for WithdrawalMigrated events raised by the IDelegationManager contract.
type IDelegationManagerWithdrawalMigratedIterator struct {
	Event *IDelegationManagerWithdrawalMigrated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IDelegationManagerWithdrawalMigratedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IDelegationManagerWithdrawalMigrated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IDelegationManagerWithdrawalMigratedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IDelegationManagerWithdrawalMigratedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IDelegationManagerWithdrawalMigrated represents a WithdrawalMigrated event raised by the IDelegationManager contract.
type IDelegationManagerWithdrawalMigrated struct {
...
func (_IDelegationManager *IDelegationManagerFilterer) FilterWithdrawalMigrated(opts *bind.FilterOpts) (*IDelegationManagerWithdrawalMigratedIterator, error) {

	logs, sub, err := _IDelegationManager.contract.FilterLogs(opts, "WithdrawalMigrated")
	if err != nil {
		return nil, err
	}
	return &IDelegationManagerWithdrawalMigratedIterator{contract: _IDelegationManager.contract, event: "WithdrawalMigrated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WithdrawalMigrated(bytes32 oldWithdrawalRoot, bytes32 newWithdrawalRoot)
func (_IDelegationManager *IDelegationManagerFilterer) WatchWithdrawalMigrated(opts *bind.WatchOpts, sink chan<- *IDelegationManagerWithdrawalMigrated) (event.Subscription, error) {

	logs, sub, err := _IDelegationManager.contract.WatchLogs(opts, "WithdrawalMigrated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IDelegationManagerWithdrawalMigrated)
				if err := _IDelegationManager.contract.UnpackLog(event, "WithdrawalMigrated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event WithdrawalMigrated(bytes32 oldWithdrawalRoot, bytes32 newWithdrawalRoot)
func (_IDelegationManager *IDelegationManagerFilterer) ParseWithdrawalMigrated(log types.Log) (*IDelegationManagerWithdrawalMigrated, error) {
	event := new(IDelegationManagerWithdrawalMigrated)
	if err := _IDelegationManager.contract.UnpackLog(event, "WithdrawalMigrated", log); err != nil {
		return nil, err
	}
