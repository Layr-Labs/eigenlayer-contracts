...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) HasActiveGenerationReservation(opts *bind.CallOpts, operatorSet OperatorSet) (bool, error) {
	var out []interface{}
	err := _CrossChainRegistryStorage.contract.Call(opts, &out, "hasActiveGenerationReservation", operatorSet)
...
//
// Solidity: function hasActiveGenerationReservation((address,uint32) operatorSet) view returns(bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) HasActiveGenerationReservation(operatorSet OperatorSet) (bool, error) {
	return _CrossChainRegistryStorage.Contract.HasActiveGenerationReservation(&_CrossChainRegistryStorage.CallOpts, operatorSet)
}

// HasActiveGenerationReservation is a free data retrieval call binding the contract method 0x36b200de.
//
// Solidity: function hasActiveGenerationReservation((address,uint32) operatorSet) view returns(bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) HasActiveGenerationReservation(operatorSet OperatorSet) (bool, error) {
	return _CrossChainRegistryStorage.Contract.HasActiveGenerationReservation(&_CrossChainRegistryStorage.CallOpts, operatorSet)
}
