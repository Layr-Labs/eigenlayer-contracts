...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) GetActiveGenerationReservationCount(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CrossChainRegistryStorage.contract.Call(opts, &out, "getActiveGenerationReservationCount")
...
//
// Solidity: function getActiveGenerationReservationCount() view returns(uint256)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) GetActiveGenerationReservationCount() (*big.Int, error) {
	return _CrossChainRegistryStorage.Contract.GetActiveGenerationReservationCount(&_CrossChainRegistryStorage.CallOpts)
}

// GetActiveGenerationReservationCount is a free data retrieval call binding the contract method 0xb186a60e.
//
// Solidity: function getActiveGenerationReservationCount() view returns(uint256)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) GetActiveGenerationReservationCount() (*big.Int, error) {
	return _CrossChainRegistryStorage.Contract.GetActiveGenerationReservationCount(&_CrossChainRegistryStorage.CallOpts)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) GetActiveGenerationReservationsByRange(opts *bind.CallOpts, startIndex *big.Int, endIndex *big.Int) ([]OperatorSet, error) {
	var out []interface{}
	err := _CrossChainRegistryStorage.contract.Call(opts, &out, "getActiveGenerationReservationsByRange", startIndex, endIndex)
...
//
// Solidity: function getActiveGenerationReservationsByRange(uint256 startIndex, uint256 endIndex) view returns((address,uint32)[])
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) GetActiveGenerationReservationsByRange(startIndex *big.Int, endIndex *big.Int) ([]OperatorSet, error) {
	return _CrossChainRegistryStorage.Contract.GetActiveGenerationReservationsByRange(&_CrossChainRegistryStorage.CallOpts, startIndex, endIndex)
}

// GetActiveGenerationReservationsByRange is a free data retrieval call binding the contract method 0xd9a6729e.
//
// Solidity: function getActiveGenerationReservationsByRange(uint256 startIndex, uint256 endIndex) view returns((address,uint32)[])
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) GetActiveGenerationReservationsByRange(startIndex *big.Int, endIndex *big.Int) ([]OperatorSet, error) {
	return _CrossChainRegistryStorage.Contract.GetActiveGenerationReservationsByRange(&_CrossChainRegistryStorage.CallOpts, startIndex, endIndex)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) GetOperatorSetConfig(opts *bind.CallOpts, operatorSet OperatorSet) (ICrossChainRegistryTypesOperatorSetConfig, bool, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorSetConfig((address,uint32) operatorSet) view returns((address,uint32), bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) GetOperatorSetConfig(operatorSet OperatorSet) (ICrossChainRegistryTypesOperatorSetConfig, bool, error) {
...
//
// Solidity: function getOperatorSetConfig((address,uint32) operatorSet) view returns((address,uint32), bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) GetOperatorSetConfig(operatorSet OperatorSet) (ICrossChainRegistryTypesOperatorSetConfig, bool, error) {
	return _CrossChainRegistryStorage.Contract.GetOperatorSetConfig(&_CrossChainRegistryStorage.CallOpts, operatorSet)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) GetOperatorTableCalculator(opts *bind.CallOpts, operatorSet OperatorSet) (common.Address, bool, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorTableCalculator((address,uint32) operatorSet) view returns(address, bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) GetOperatorTableCalculator(operatorSet OperatorSet) (common.Address, bool, error) {
...
//
// Solidity: function getOperatorTableCalculator((address,uint32) operatorSet) view returns(address, bool)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) GetOperatorTableCalculator(operatorSet OperatorSet) (common.Address, bool, error) {
	return _CrossChainRegistryStorage.Contract.GetOperatorTableCalculator(&_CrossChainRegistryStorage.CallOpts, operatorSet)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCaller) GetTableUpdateCadence(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _CrossChainRegistryStorage.contract.Call(opts, &out, "getTableUpdateCadence")
...
//
// Solidity: function getTableUpdateCadence() view returns(uint32)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) GetTableUpdateCadence() (uint32, error) {
	return _CrossChainRegistryStorage.Contract.GetTableUpdateCadence(&_CrossChainRegistryStorage.CallOpts)
}

// GetTableUpdateCadence is a free data retrieval call binding the contract method 0xac505f4b.
//
// Solidity: function getTableUpdateCadence() view returns(uint32)
func (_CrossChainRegistryStorage *CrossChainRegistryStorageCallerSession) GetTableUpdateCadence() (uint32, error) {
	return _CrossChainRegistryStorage.Contract.GetTableUpdateCadence(&_CrossChainRegistryStorage.CallOpts)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageTransactor) CreateGenerationReservation(opts *bind.TransactOpts, operatorSet OperatorSet, operatorTableCalculator common.Address, config ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.contract.Transact(opts, "createGenerationReservation", operatorSet, operatorTableCalculator, config)
}

// CreateGenerationReservation is a paid mutator transaction binding the contract method 0xd5044911.
//
// Solidity: function createGenerationReservation((address,uint32) operatorSet, address operatorTableCalculator, (address,uint32) config) returns()
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) CreateGenerationReservation(operatorSet OperatorSet, operatorTableCalculator common.Address, config ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.Contract.CreateGenerationReservation(&_CrossChainRegistryStorage.TransactOpts, operatorSet, operatorTableCalculator, config)
}

// CreateGenerationReservation is a paid mutator transaction binding the contract method 0xd5044911.
//
// Solidity: function createGenerationReservation((address,uint32) operatorSet, address operatorTableCalculator, (address,uint32) config) returns()
func (_CrossChainRegistryStorage *CrossChainRegistryStorageTransactorSession) CreateGenerationReservation(operatorSet OperatorSet, operatorTableCalculator common.Address, config ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.Contract.CreateGenerationReservation(&_CrossChainRegistryStorage.TransactOpts, operatorSet, operatorTableCalculator, config)
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageTransactor) SetTableUpdateCadence(opts *bind.TransactOpts, tableUpdateCadence uint32) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.contract.Transact(opts, "setTableUpdateCadence", tableUpdateCadence)
}

// SetTableUpdateCadence is a paid mutator transaction binding the contract method 0xd6db9e25.
//
// Solidity: function setTableUpdateCadence(uint32 tableUpdateCadence) returns()
func (_CrossChainRegistryStorage *CrossChainRegistryStorageSession) SetTableUpdateCadence(tableUpdateCadence uint32) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.Contract.SetTableUpdateCadence(&_CrossChainRegistryStorage.TransactOpts, tableUpdateCadence)
}

// SetTableUpdateCadence is a paid mutator transaction binding the contract method 0xd6db9e25.
//
// Solidity: function setTableUpdateCadence(uint32 tableUpdateCadence) returns()
func (_CrossChainRegistryStorage *CrossChainRegistryStorageTransactorSession) SetTableUpdateCadence(tableUpdateCadence uint32) (*types.Transaction, error) {
	return _CrossChainRegistryStorage.Contract.SetTableUpdateCadence(&_CrossChainRegistryStorage.TransactOpts, tableUpdateCadence)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CrossChainRegistryStorageTableUpdateCadenceSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CrossChainRegistryStorageTableUpdateCadenceSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CrossChainRegistryStorageTableUpdateCadenceSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CrossChainRegistryStorageTableUpdateCadenceSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageFilterer) FilterTableUpdateCadenceSet(opts *bind.FilterOpts) (*CrossChainRegistryStorageTableUpdateCadenceSetIterator, error) {
	...
	logs, sub, err := _CrossChainRegistryStorage.contract.FilterLogs(opts, "TableUpdateCadenceSet")
	if err != nil {
		return nil, err
	}
	return &CrossChainRegistryStorageTableUpdateCadenceSetIterator{contract: _CrossChainRegistryStorage.contract, event: "TableUpdateCadenceSet", logs: logs, sub: sub}, nil
}
...
func (_CrossChainRegistryStorage *CrossChainRegistryStorageFilterer) WatchTableUpdateCadenceSet(opts *bind.WatchOpts, sink chan<- *CrossChainRegistryStorageTableUpdateCadenceSet) (event.Subscription, error) {
	...
	logs, sub, err := _CrossChainRegistryStorage.contract.WatchLogs(opts, "TableUpdateCadenceSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CrossChainRegistryStorageTableUpdateCadenceSet)
				if err := _CrossChainRegistryStorage.contract.UnpackLog(event, "TableUpdateCadenceSet", log); err != nil {
					return err
				}
				event.Raw = log
