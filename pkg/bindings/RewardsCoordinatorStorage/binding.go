...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) DistributionRoots(opts *bind.CallOpts, arg0 *big.Int) (struct {
	Root                           [32]byte
	RewardsCalculationEndTimestamp uint32
	ActivatedAt                    uint32
}, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "distributionRoots", arg0)
...
//
// Solidity: function distributionRoots(uint256 ) view returns(bytes32 root, uint32 rewardsCalculationEndTimestamp, uint32 activatedAt)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) DistributionRoots(arg0 *big.Int) (struct {
	Root                           [32]byte
	RewardsCalculationEndTimestamp uint32
	ActivatedAt                    uint32
}, error) {
	return _RewardsCoordinatorStorage.Contract.DistributionRoots(&_RewardsCoordinatorStorage.CallOpts, arg0)
}

// DistributionRoots is a free data retrieval call binding the contract method 0x5971b3f8.
//
// Solidity: function distributionRoots(uint256 ) view returns(bytes32 root, uint32 rewardsCalculationEndTimestamp, uint32 activatedAt)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) DistributionRoots(arg0 *big.Int) (struct {
	Root                           [32]byte
	RewardsCalculationEndTimestamp uint32
	ActivatedAt                    uint32
}, error) {
...
// CreateDirectAVSRewardSubmission is a paid mutator transaction binding the contract method 0x0a6563e3.
//
// Solidity: function createDirectAVSRewardSubmission(address[] earners, uint256[] amounts, address token) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactor) CreateDirectAVSRewardSubmission(opts *bind.TransactOpts, earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.contract.Transact(opts, "createDirectAVSRewardSubmission", earners, amounts, token)
}

// CreateDirectAVSRewardSubmission is a paid mutator transaction binding the contract method 0x0a6563e3.
//
// Solidity: function createDirectAVSRewardSubmission(address[] earners, uint256[] amounts, address token) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) CreateDirectAVSRewardSubmission(earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateDirectAVSRewardSubmission(&_RewardsCoordinatorStorage.TransactOpts, earners, amounts, token)
}

// CreateDirectAVSRewardSubmission is a paid mutator transaction binding the contract method 0x0a6563e3.
//
// Solidity: function createDirectAVSRewardSubmission(address[] earners, uint256[] amounts, address token) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactorSession) CreateDirectAVSRewardSubmission(earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateDirectAVSRewardSubmission(&_RewardsCoordinatorStorage.TransactOpts, earners, amounts, token)
}
...
// RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator is returned from FilterDirectAVSRewardSubmissionCreated and is used to iterate over the raw logs and unpacked data for DirectAVSRewardSubmissionCreated events raised by the RewardsCoordinatorStorage contract.
type RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator struct {
	Event *RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated represents a DirectAVSRewardSubmissionCreated event raised by the RewardsCoordinatorStorage contract.
type RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated struct {
	Avs    common.Address
	Earner common.Address
	Token  common.Address
	Amount *big.Int
...
// FilterDirectAVSRewardSubmissionCreated is a free log retrieval operation binding the contract event 0x27be8ada741d1ca75c92c9c36f61ad5a726d5f5ee4e024b597f9b04d8d1b6089.
//
// Solidity: event DirectAVSRewardSubmissionCreated(address indexed avs, address indexed earner, address token, uint256 amount)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) FilterDirectAVSRewardSubmissionCreated(opts *bind.FilterOpts, avs []common.Address, earner []common.Address) (*RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.FilterLogs(opts, "DirectAVSRewardSubmissionCreated", avsRule, earnerRule)
	if err != nil {
		return nil, err
	}
	return &RewardsCoordinatorStorageDirectAVSRewardSubmissionCreatedIterator{contract: _RewardsCoordinatorStorage.contract, event: "DirectAVSRewardSubmissionCreated", logs: logs, sub: sub}, nil
}

// WatchDirectAVSRewardSubmissionCreated is a free log subscription operation binding the contract event 0x27be8ada741d1ca75c92c9c36f61ad5a726d5f5ee4e024b597f9b04d8d1b6089.
//
// Solidity: event DirectAVSRewardSubmissionCreated(address indexed avs, address indexed earner, address token, uint256 amount)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) WatchDirectAVSRewardSubmissionCreated(opts *bind.WatchOpts, sink chan<- *RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated, avs []common.Address, earner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.WatchLogs(opts, "DirectAVSRewardSubmissionCreated", avsRule, earnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated)
				if err := _RewardsCoordinatorStorage.contract.UnpackLog(event, "DirectAVSRewardSubmissionCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDirectAVSRewardSubmissionCreated is a log parse operation binding the contract event 0x27be8ada741d1ca75c92c9c36f61ad5a726d5f5ee4e024b597f9b04d8d1b6089.
//
// Solidity: event DirectAVSRewardSubmissionCreated(address indexed avs, address indexed earner, address token, uint256 amount)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) ParseDirectAVSRewardSubmissionCreated(log types.Log) (*RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated, error) {
	event := new(RewardsCoordinatorStorageDirectAVSRewardSubmissionCreated)
	if err := _RewardsCoordinatorStorage.contract.UnpackLog(event, "DirectAVSRewardSubmissionCreated", log); err != nil {
		return nil, err
	}
