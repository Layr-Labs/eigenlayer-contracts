...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) IsOperatorSetPerformanceRewardsSubmissionHash(opts *bind.CallOpts, avs common.Address, hash [32]byte) (bool, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "isOperatorSetPerformanceRewardsSubmissionHash", avs, hash)
...
//
// Solidity: function isOperatorSetPerformanceRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) IsOperatorSetPerformanceRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsOperatorSetPerformanceRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}

// IsOperatorSetPerformanceRewardsSubmissionHash is a free data retrieval call binding the contract method 0xfc24cede.
//
// Solidity: function isOperatorSetPerformanceRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) IsOperatorSetPerformanceRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsOperatorSetPerformanceRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) FilterOperatorDirectedOperatorSetRewardsSubmissionCreated(opts *bind.FilterOpts, caller []common.Address, operatorSet []OperatorSet, operatorDirectedRewardsSubmissionHash [][32]byte) (*RewardsCoordinatorStorageOperatorDirectedOperatorSetRewardsSubmissionCreatedIterator, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.FilterLogs(opts, "OperatorDirectedOperatorSetRewardsSubmissionCreated", callerRule, operatorSetRule, operatorDirectedRewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event OperatorDirectedOperatorSetRewardsSubmissionCreated(address indexed caller, (address,uint32) indexed operatorSet, bytes32 indexed operatorDirectedRewardsSubmissionHash, uint256 submissionNonce, ((address,uint96)[],address,(address,uint256)[],uint32,uint32,string) operatorDirectedRewardsSubmission)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) WatchOperatorDirectedOperatorSetRewardsSubmissionCreated(opts *bind.WatchOpts, sink chan<- *RewardsCoordinatorStorageOperatorDirectedOperatorSetRewardsSubmissionCreated, caller []common.Address, operatorSet []OperatorSet, operatorDirectedRewardsSubmissionHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.WatchLogs(opts, "OperatorDirectedOperatorSetRewardsSubmissionCreated", callerRule, operatorSetRule, operatorDirectedRewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) FilterOperatorSetSplitBipsSet(opts *bind.FilterOpts, caller []common.Address, operator []common.Address, operatorSet []OperatorSet) (*RewardsCoordinatorStorageOperatorSetSplitBipsSetIterator, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.FilterLogs(opts, "OperatorSetSplitBipsSet", callerRule, operatorRule, operatorSetRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event OperatorSetSplitBipsSet(address indexed caller, address indexed operator, (address,uint32) indexed operatorSet, uint32 activatedAt, uint16 oldOperatorSetSplitBips, uint16 newOperatorSetSplitBips)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) WatchOperatorSetSplitBipsSet(opts *bind.WatchOpts, sink chan<- *RewardsCoordinatorStorageOperatorSetSplitBipsSet, caller []common.Address, operator []common.Address, operatorSet []OperatorSet) (event.Subscription, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.WatchLogs(opts, "OperatorSetSplitBipsSet", callerRule, operatorRule, operatorSetRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
