...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) IsTotalStakeRewardsSubmissionHash(opts *bind.CallOpts, avs common.Address, hash [32]byte) (bool, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "isTotalStakeRewardsSubmissionHash", avs, hash)
...
//
// Solidity: function isTotalStakeRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) IsTotalStakeRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsTotalStakeRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}

// IsTotalStakeRewardsSubmissionHash is a free data retrieval call binding the contract method 0xb73c1b92.
//
// Solidity: function isTotalStakeRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) IsTotalStakeRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsTotalStakeRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCaller) IsUniqueStakeRewardsSubmissionHash(opts *bind.CallOpts, avs common.Address, hash [32]byte) (bool, error) {
	var out []interface{}
	err := _RewardsCoordinatorStorage.contract.Call(opts, &out, "isUniqueStakeRewardsSubmissionHash", avs, hash)
...
//
// Solidity: function isUniqueStakeRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) IsUniqueStakeRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsUniqueStakeRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}

// IsUniqueStakeRewardsSubmissionHash is a free data retrieval call binding the contract method 0x2943e3ff.
//
// Solidity: function isUniqueStakeRewardsSubmissionHash(address avs, bytes32 hash) view returns(bool valid)
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageCallerSession) IsUniqueStakeRewardsSubmissionHash(avs common.Address, hash [32]byte) (bool, error) {
	return _RewardsCoordinatorStorage.Contract.IsUniqueStakeRewardsSubmissionHash(&_RewardsCoordinatorStorage.CallOpts, avs, hash)
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactor) CreateTotalStakeRewardsSubmission(opts *bind.TransactOpts, operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.contract.Transact(opts, "createTotalStakeRewardsSubmission", operatorSet, rewardsSubmissions)
}

// CreateTotalStakeRewardsSubmission is a paid mutator transaction binding the contract method 0x8cb0ae1b.
//
// Solidity: function createTotalStakeRewardsSubmission((address,uint32) operatorSet, ((address,uint96)[],address,uint256,uint32,uint32)[] rewardsSubmissions) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) CreateTotalStakeRewardsSubmission(operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateTotalStakeRewardsSubmission(&_RewardsCoordinatorStorage.TransactOpts, operatorSet, rewardsSubmissions)
}

// CreateTotalStakeRewardsSubmission is a paid mutator transaction binding the contract method 0x8cb0ae1b.
//
// Solidity: function createTotalStakeRewardsSubmission((address,uint32) operatorSet, ((address,uint96)[],address,uint256,uint32,uint32)[] rewardsSubmissions) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactorSession) CreateTotalStakeRewardsSubmission(operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateTotalStakeRewardsSubmission(&_RewardsCoordinatorStorage.TransactOpts, operatorSet, rewardsSubmissions)
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactor) CreateUniqueStakeRewardsSubmission(opts *bind.TransactOpts, operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.contract.Transact(opts, "createUniqueStakeRewardsSubmission", operatorSet, rewardsSubmissions)
}

// CreateUniqueStakeRewardsSubmission is a paid mutator transaction binding the contract method 0x7ae30583.
//
// Solidity: function createUniqueStakeRewardsSubmission((address,uint32) operatorSet, ((address,uint96)[],address,uint256,uint32,uint32)[] rewardsSubmissions) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageSession) CreateUniqueStakeRewardsSubmission(operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateUniqueStakeRewardsSubmission(&_RewardsCoordinatorStorage.TransactOpts, operatorSet, rewardsSubmissions)
}

// CreateUniqueStakeRewardsSubmission is a paid mutator transaction binding the contract method 0x7ae30583.
//
// Solidity: function createUniqueStakeRewardsSubmission((address,uint32) operatorSet, ((address,uint96)[],address,uint256,uint32,uint32)[] rewardsSubmissions) returns()
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageTransactorSession) CreateUniqueStakeRewardsSubmission(operatorSet OperatorSet, rewardsSubmissions []IRewardsCoordinatorTypesRewardsSubmission) (*types.Transaction, error) {
	return _RewardsCoordinatorStorage.Contract.CreateUniqueStakeRewardsSubmission(&_RewardsCoordinatorStorage.TransactOpts, operatorSet, rewardsSubmissions)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) FilterTotalStakeRewardsSubmissionCreated(opts *bind.FilterOpts, caller []common.Address, rewardsSubmissionHash [][32]byte) (*RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreatedIterator, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.FilterLogs(opts, "TotalStakeRewardsSubmissionCreated", callerRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return &RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreatedIterator{contract: _RewardsCoordinatorStorage.contract, event: "TotalStakeRewardsSubmissionCreated", logs: logs, sub: sub}, nil
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) WatchTotalStakeRewardsSubmissionCreated(opts *bind.WatchOpts, sink chan<- *RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreated, caller []common.Address, rewardsSubmissionHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.WatchLogs(opts, "TotalStakeRewardsSubmissionCreated", callerRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(RewardsCoordinatorStorageTotalStakeRewardsSubmissionCreated)
				if err := _RewardsCoordinatorStorage.contract.UnpackLog(event, "TotalStakeRewardsSubmissionCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) FilterUniqueStakeRewardsSubmissionCreated(opts *bind.FilterOpts, caller []common.Address, rewardsSubmissionHash [][32]byte) (*RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreatedIterator, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.FilterLogs(opts, "UniqueStakeRewardsSubmissionCreated", callerRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return &RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreatedIterator{contract: _RewardsCoordinatorStorage.contract, event: "UniqueStakeRewardsSubmissionCreated", logs: logs, sub: sub}, nil
}
...
func (_RewardsCoordinatorStorage *RewardsCoordinatorStorageFilterer) WatchUniqueStakeRewardsSubmissionCreated(opts *bind.WatchOpts, sink chan<- *RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreated, caller []common.Address, rewardsSubmissionHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _RewardsCoordinatorStorage.contract.WatchLogs(opts, "UniqueStakeRewardsSubmissionCreated", callerRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(RewardsCoordinatorStorageUniqueStakeRewardsSubmissionCreated)
				if err := _RewardsCoordinatorStorage.contract.UnpackLog(event, "UniqueStakeRewardsSubmissionCreated", log); err != nil {
					return err
				}
				event.Raw = log
