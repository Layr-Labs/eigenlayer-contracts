...
func (_AllocationManagerStorage *AllocationManagerStorageCaller) SLASHERCONFIGURATIONDELAY(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _AllocationManagerStorage.contract.Call(opts, &out, "SLASHER_CONFIGURATION_DELAY")
...
//
// Solidity: function SLASHER_CONFIGURATION_DELAY() view returns(uint32)
func (_AllocationManagerStorage *AllocationManagerStorageSession) SLASHERCONFIGURATIONDELAY() (uint32, error) {
	return _AllocationManagerStorage.Contract.SLASHERCONFIGURATIONDELAY(&_AllocationManagerStorage.CallOpts)
}

// SLASHERCONFIGURATIONDELAY is a free data retrieval call binding the contract method 0x67aeaa53.
//
// Solidity: function SLASHER_CONFIGURATION_DELAY() view returns(uint32)
func (_AllocationManagerStorage *AllocationManagerStorageCallerSession) SLASHERCONFIGURATIONDELAY() (uint32, error) {
	return _AllocationManagerStorage.Contract.SLASHERCONFIGURATIONDELAY(&_AllocationManagerStorage.CallOpts)
}
