...
func (_IProtocolRegistry *IProtocolRegistryTransactor) Configure(opts *bind.TransactOpts, name string, config IProtocolRegistryTypesDeploymentConfig) (*types.Transaction, error) {
	return _IProtocolRegistry.contract.Transact(opts, "configure", name, config)
}

// Configure is a paid mutator transaction binding the contract method 0x0b6cc4f9.
//
// Solidity: function configure(string name, (bool,bool) config) returns()
func (_IProtocolRegistry *IProtocolRegistrySession) Configure(name string, config IProtocolRegistryTypesDeploymentConfig) (*types.Transaction, error) {
	return _IProtocolRegistry.Contract.Configure(&_IProtocolRegistry.TransactOpts, name, config)
}

// Configure is a paid mutator transaction binding the contract method 0x0b6cc4f9.
//
// Solidity: function configure(string name, (bool,bool) config) returns()
func (_IProtocolRegistry *IProtocolRegistryTransactorSession) Configure(name string, config IProtocolRegistryTypesDeploymentConfig) (*types.Transaction, error) {
	return _IProtocolRegistry.Contract.Configure(&_IProtocolRegistry.TransactOpts, name, config)
}
...
func (it *IProtocolRegistryDeploymentConfigDeletedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IProtocolRegistryDeploymentConfigDeleted)
...
func (_IProtocolRegistry *IProtocolRegistryFilterer) FilterDeploymentConfigDeleted(opts *bind.FilterOpts, addr []common.Address) (*IProtocolRegistryDeploymentConfigDeletedIterator, error) {
	...
	logs, sub, err := _IProtocolRegistry.contract.FilterLogs(opts, "DeploymentConfigDeleted", addrRule)
	if err != nil {
		return nil, err
	}
	return &IProtocolRegistryDeploymentConfigDeletedIterator{contract: _IProtocolRegistry.contract, event: "DeploymentConfigDeleted", logs: logs, sub: sub}, nil
}
...
func (_IProtocolRegistry *IProtocolRegistryFilterer) WatchDeploymentConfigDeleted(opts *bind.WatchOpts, sink chan<- *IProtocolRegistryDeploymentConfigDeleted, addr []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IProtocolRegistry.contract.WatchLogs(opts, "DeploymentConfigDeleted", addrRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IProtocolRegistryDeploymentConfigDeleted)
				if err := _IProtocolRegistry.contract.UnpackLog(event, "DeploymentConfigDeleted", log); err != nil {
					return err
				}
				event.Raw = log
