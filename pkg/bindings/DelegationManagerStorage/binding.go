...
// Allocator is a free data retrieval call binding the contract method 0x69066d91.
//
// Solidity: function allocator(address operator) view returns(address)
func (_DelegationManagerStorage *DelegationManagerStorageCaller) Allocator(opts *bind.CallOpts, operator common.Address) (common.Address, error) {
	var out []interface{}
	err := _DelegationManagerStorage.contract.Call(opts, &out, "allocator", operator)
...
//
// Solidity: function allocator(address operator) view returns(address)
func (_DelegationManagerStorage *DelegationManagerStorageSession) Allocator(operator common.Address) (common.Address, error) {
	return _DelegationManagerStorage.Contract.Allocator(&_DelegationManagerStorage.CallOpts, operator)
}

// Allocator is a free data retrieval call binding the contract method 0x69066d91.
//
// Solidity: function allocator(address operator) view returns(address)
func (_DelegationManagerStorage *DelegationManagerStorageCallerSession) Allocator(operator common.Address) (common.Address, error) {
	return _DelegationManagerStorage.Contract.Allocator(&_DelegationManagerStorage.CallOpts, operator)
}
