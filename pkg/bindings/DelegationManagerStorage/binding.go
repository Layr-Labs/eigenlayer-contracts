...
func (_DelegationManagerStorage *DelegationManagerStorageCaller) EarningsReceiver(opts *bind.CallOpts, operator common.Address) (common.Address, error) {
	var out []interface{}
	err := _DelegationManagerStorage.contract.Call(opts, &out, "earningsReceiver", operator)
...
//
// Solidity: function earningsReceiver(address operator) view returns(address)
func (_DelegationManagerStorage *DelegationManagerStorageSession) EarningsReceiver(operator common.Address) (common.Address, error) {
	return _DelegationManagerStorage.Contract.EarningsReceiver(&_DelegationManagerStorage.CallOpts, operator)
}

// EarningsReceiver is a free data retrieval call binding the contract method 0x5f966f14.
//
// Solidity: function earningsReceiver(address operator) view returns(address)
func (_DelegationManagerStorage *DelegationManagerStorageCallerSession) EarningsReceiver(operator common.Address) (common.Address, error) {
	return _DelegationManagerStorage.Contract.EarningsReceiver(&_DelegationManagerStorage.CallOpts, operator)
}
...
func (_DelegationManagerStorage *DelegationManagerStorageTransactor) MigrateQueuedWithdrawals(opts *bind.TransactOpts, withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _DelegationManagerStorage.contract.Transact(opts, "migrateQueuedWithdrawals", withdrawalsToQueue)
}

// MigrateQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5cfe8d2c.
//
// Solidity: function migrateQueuedWithdrawals((address[],uint256[],address,(address,uint96),uint32,address)[] withdrawalsToQueue) returns()
func (_DelegationManagerStorage *DelegationManagerStorageSession) MigrateQueuedWithdrawals(withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.MigrateQueuedWithdrawals(&_DelegationManagerStorage.TransactOpts, withdrawalsToQueue)
}

// MigrateQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5cfe8d2c.
//
// Solidity: function migrateQueuedWithdrawals((address[],uint256[],address,(address,uint96),uint32,address)[] withdrawalsToQueue) returns()
func (_DelegationManagerStorage *DelegationManagerStorageTransactorSession) MigrateQueuedWithdrawals(withdrawalsToQueue []IStrategyManagerDeprecatedStructQueuedWithdrawal) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.MigrateQueuedWithdrawals(&_DelegationManagerStorage.TransactOpts, withdrawalsToQueue)
}
...
// DelegationManagerStorageWithdrawalMigratedIterator is returned from FilterWithdrawalMigrated and is used to iterate over the raw logs and unpacked data for WithdrawalMigrated events raised by the DelegationManagerStorage contract.
type DelegationManagerStorageWithdrawalMigratedIterator struct {
	Event *DelegationManagerStorageWithdrawalMigrated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *DelegationManagerStorageWithdrawalMigratedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DelegationManagerStorageWithdrawalMigrated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *DelegationManagerStorageWithdrawalMigratedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *DelegationManagerStorageWithdrawalMigratedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// DelegationManagerStorageWithdrawalMigrated represents a WithdrawalMigrated event raised by the DelegationManagerStorage contract.
type DelegationManagerStorageWithdrawalMigrated struct {
...
func (_DelegationManagerStorage *DelegationManagerStorageFilterer) FilterWithdrawalMigrated(opts *bind.FilterOpts) (*DelegationManagerStorageWithdrawalMigratedIterator, error) {

	logs, sub, err := _DelegationManagerStorage.contract.FilterLogs(opts, "WithdrawalMigrated")
	if err != nil {
		return nil, err
	}
	return &DelegationManagerStorageWithdrawalMigratedIterator{contract: _DelegationManagerStorage.contract, event: "WithdrawalMigrated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WithdrawalMigrated(bytes32 oldWithdrawalRoot, bytes32 newWithdrawalRoot)
func (_DelegationManagerStorage *DelegationManagerStorageFilterer) WatchWithdrawalMigrated(opts *bind.WatchOpts, sink chan<- *DelegationManagerStorageWithdrawalMigrated) (event.Subscription, error) {

	logs, sub, err := _DelegationManagerStorage.contract.WatchLogs(opts, "WithdrawalMigrated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DelegationManagerStorageWithdrawalMigrated)
				if err := _DelegationManagerStorage.contract.UnpackLog(event, "WithdrawalMigrated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event WithdrawalMigrated(bytes32 oldWithdrawalRoot, bytes32 newWithdrawalRoot)
func (_DelegationManagerStorage *DelegationManagerStorageFilterer) ParseWithdrawalMigrated(log types.Log) (*DelegationManagerStorageWithdrawalMigrated, error) {
	event := new(DelegationManagerStorageWithdrawalMigrated)
	if err := _DelegationManagerStorage.contract.UnpackLog(event, "WithdrawalMigrated", log); err != nil {
		return nil, err
	}
