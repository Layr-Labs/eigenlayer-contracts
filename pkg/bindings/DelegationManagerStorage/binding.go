...
func (_DelegationManagerStorage *DelegationManagerStorageCaller) MINWITHDRAWALDELAYBLOCKS(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _DelegationManagerStorage.contract.Call(opts, &out, "MIN_WITHDRAWAL_DELAY_BLOCKS")
...
func (_DelegationManagerStorage *DelegationManagerStorageCaller) QueuedWithdrawals(opts *bind.CallOpts, withdrawalRoot [32]byte) (struct {
	Staker      common.Address
	DelegatedTo common.Address
	Withdrawer  common.Address
	Nonce       *big.Int
...
//
// Solidity: function queuedWithdrawals(bytes32 withdrawalRoot) view returns(address staker, address delegatedTo, address withdrawer, uint256 nonce, uint32 startBlock)
func (_DelegationManagerStorage *DelegationManagerStorageSession) QueuedWithdrawals(withdrawalRoot [32]byte) (struct {
	Staker      common.Address
	DelegatedTo common.Address
	Withdrawer  common.Address
	Nonce       *big.Int
...
//
// Solidity: function queuedWithdrawals(bytes32 withdrawalRoot) view returns(address staker, address delegatedTo, address withdrawer, uint256 nonce, uint32 startBlock)
func (_DelegationManagerStorage *DelegationManagerStorageCallerSession) QueuedWithdrawals(withdrawalRoot [32]byte) (struct {
	Staker      common.Address
	DelegatedTo common.Address
	Withdrawer  common.Address
	Nonce       *big.Int
...
func (_DelegationManagerStorage *DelegationManagerStorageTransactor) CompleteQueuedWithdrawals(opts *bind.TransactOpts, tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.contract.Transact(opts, "completeQueuedWithdrawals", tokens, receiveAsTokens, numToComplete)
}

// CompleteQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5f48e667.
//
// Solidity: function completeQueuedWithdrawals(address[][] tokens, bool[] receiveAsTokens, uint256 numToComplete) returns()
func (_DelegationManagerStorage *DelegationManagerStorageSession) CompleteQueuedWithdrawals(tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.CompleteQueuedWithdrawals(&_DelegationManagerStorage.TransactOpts, tokens, receiveAsTokens, numToComplete)
}

// CompleteQueuedWithdrawals is a paid mutator transaction binding the contract method 0x5f48e667.
//
// Solidity: function completeQueuedWithdrawals(address[][] tokens, bool[] receiveAsTokens, uint256 numToComplete) returns()
func (_DelegationManagerStorage *DelegationManagerStorageTransactorSession) CompleteQueuedWithdrawals(tokens [][]common.Address, receiveAsTokens []bool, numToComplete *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.CompleteQueuedWithdrawals(&_DelegationManagerStorage.TransactOpts, tokens, receiveAsTokens, numToComplete)
}
...
func (_DelegationManagerStorage *DelegationManagerStorageTransactor) CompleteQueuedWithdrawals0(opts *bind.TransactOpts, withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _DelegationManagerStorage.contract.Transact(opts, "completeQueuedWithdrawals0", withdrawals, tokens, receiveAsTokens)
}

// CompleteQueuedWithdrawals0 is a paid mutator transaction binding the contract method 0x9435bb43.
//
// Solidity: function completeQueuedWithdrawals((address,address,address,uint256,uint32,address[],uint256[])[] withdrawals, address[][] tokens, bool[] receiveAsTokens) returns()
func (_DelegationManagerStorage *DelegationManagerStorageSession) CompleteQueuedWithdrawals0(withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.CompleteQueuedWithdrawals0(&_DelegationManagerStorage.TransactOpts, withdrawals, tokens, receiveAsTokens)
}

// CompleteQueuedWithdrawals0 is a paid mutator transaction binding the contract method 0x9435bb43.
//
// Solidity: function completeQueuedWithdrawals((address,address,address,uint256,uint32,address[],uint256[])[] withdrawals, address[][] tokens, bool[] receiveAsTokens) returns()
func (_DelegationManagerStorage *DelegationManagerStorageTransactorSession) CompleteQueuedWithdrawals0(withdrawals []IDelegationManagerTypesWithdrawal, tokens [][]common.Address, receiveAsTokens []bool) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.CompleteQueuedWithdrawals0(&_DelegationManagerStorage.TransactOpts, withdrawals, tokens, receiveAsTokens)
}
...
func (_DelegationManagerStorage *DelegationManagerStorageTransactor) DecreaseDelegatedShares(opts *bind.TransactOpts, staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.contract.Transact(opts, "decreaseDelegatedShares", staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}

// DecreaseDelegatedShares is a paid mutator transaction binding the contract method 0x63ceb57d.
//
// Solidity: function decreaseDelegatedShares(address staker, uint256 curDepositShares, uint64 prevBeaconChainSlashingFactor, uint256 wadSlashed) returns()
func (_DelegationManagerStorage *DelegationManagerStorageSession) DecreaseDelegatedShares(staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.DecreaseDelegatedShares(&_DelegationManagerStorage.TransactOpts, staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}

// DecreaseDelegatedShares is a paid mutator transaction binding the contract method 0x63ceb57d.
//
// Solidity: function decreaseDelegatedShares(address staker, uint256 curDepositShares, uint64 prevBeaconChainSlashingFactor, uint256 wadSlashed) returns()
func (_DelegationManagerStorage *DelegationManagerStorageTransactorSession) DecreaseDelegatedShares(staker common.Address, curDepositShares *big.Int, prevBeaconChainSlashingFactor uint64, wadSlashed *big.Int) (*types.Transaction, error) {
	return _DelegationManagerStorage.Contract.DecreaseDelegatedShares(&_DelegationManagerStorage.TransactOpts, staker, curDepositShares, prevBeaconChainSlashingFactor, wadSlashed)
}
