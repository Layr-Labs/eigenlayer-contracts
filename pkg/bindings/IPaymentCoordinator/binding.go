...
func (_IPaymentCoordinator *IPaymentCoordinatorCaller) GetDistributionRootsLength(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _IPaymentCoordinator.contract.Call(opts, &out, "getDistributionRootsLength")
...
//
// Solidity: function getDistributionRootsLength() view returns(uint256)
func (_IPaymentCoordinator *IPaymentCoordinatorSession) GetDistributionRootsLength() (*big.Int, error) {
	return _IPaymentCoordinator.Contract.GetDistributionRootsLength(&_IPaymentCoordinator.CallOpts)
}

// GetDistributionRootsLength is a free data retrieval call binding the contract method 0x7b8f8b05.
//
// Solidity: function getDistributionRootsLength() view returns(uint256)
func (_IPaymentCoordinator *IPaymentCoordinatorCallerSession) GetDistributionRootsLength() (*big.Int, error) {
	return _IPaymentCoordinator.Contract.GetDistributionRootsLength(&_IPaymentCoordinator.CallOpts)
}
