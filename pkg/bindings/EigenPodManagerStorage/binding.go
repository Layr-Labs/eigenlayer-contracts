...
// FilterPodSharesUpdated is a free log retrieval operation binding the contract event 0x3d47d90127da6f6e906ad49f855495ec9dae64c2adf7386f9496ddc1f5f2ead7.
//
// Solidity: event PodSharesUpdated(address indexed podOwner, address indexed pod, int256 newTotalShares, int256 sharesDelta)
func (_EigenPodManagerStorage *EigenPodManagerStorageFilterer) FilterPodSharesUpdated(opts *bind.FilterOpts, podOwner []common.Address, pod []common.Address) (*EigenPodManagerStoragePodSharesUpdatedIterator, error) {
	...
	logs, sub, err := _EigenPodManagerStorage.contract.FilterLogs(opts, "PodSharesUpdated", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
...
// WatchPodSharesUpdated is a free log subscription operation binding the contract event 0x3d47d90127da6f6e906ad49f855495ec9dae64c2adf7386f9496ddc1f5f2ead7.
//
// Solidity: event PodSharesUpdated(address indexed podOwner, address indexed pod, int256 newTotalShares, int256 sharesDelta)
func (_EigenPodManagerStorage *EigenPodManagerStorageFilterer) WatchPodSharesUpdated(opts *bind.WatchOpts, sink chan<- *EigenPodManagerStoragePodSharesUpdated, podOwner []common.Address, pod []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _EigenPodManagerStorage.contract.WatchLogs(opts, "PodSharesUpdated", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParsePodSharesUpdated is a log parse operation binding the contract event 0x3d47d90127da6f6e906ad49f855495ec9dae64c2adf7386f9496ddc1f5f2ead7.
//
// Solidity: event PodSharesUpdated(address indexed podOwner, address indexed pod, int256 newTotalShares, int256 sharesDelta)
