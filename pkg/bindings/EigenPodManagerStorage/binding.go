...
// TRUSTEDCHECKPOINTTIMESTAMP is a free data retrieval call binding the contract method 0x8307d693.
//
// Solidity: function TRUSTED_CHECKPOINT_TIMESTAMP() view returns(uint64)
func (_EigenPodManagerStorage *EigenPodManagerStorageCaller) TRUSTEDCHECKPOINTTIMESTAMP(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _EigenPodManagerStorage.contract.Call(opts, &out, "TRUSTED_CHECKPOINT_TIMESTAMP")
...
//
// Solidity: function TRUSTED_CHECKPOINT_TIMESTAMP() view returns(uint64)
func (_EigenPodManagerStorage *EigenPodManagerStorageSession) TRUSTEDCHECKPOINTTIMESTAMP() (uint64, error) {
	return _EigenPodManagerStorage.Contract.TRUSTEDCHECKPOINTTIMESTAMP(&_EigenPodManagerStorage.CallOpts)
}

// TRUSTEDCHECKPOINTTIMESTAMP is a free data retrieval call binding the contract method 0x8307d693.
//
// Solidity: function TRUSTED_CHECKPOINT_TIMESTAMP() view returns(uint64)
func (_EigenPodManagerStorage *EigenPodManagerStorageCallerSession) TRUSTEDCHECKPOINTTIMESTAMP() (uint64, error) {
	return _EigenPodManagerStorage.Contract.TRUSTEDCHECKPOINTTIMESTAMP(&_EigenPodManagerStorage.CallOpts)
}
...
// DisablePod is a paid mutator transaction binding the contract method 0x630f5323.
//
// Solidity: function disablePod() returns()
func (_EigenPodManagerStorage *EigenPodManagerStorageTransactor) DisablePod(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _EigenPodManagerStorage.contract.Transact(opts, "disablePod")
}

// DisablePod is a paid mutator transaction binding the contract method 0x630f5323.
//
// Solidity: function disablePod() returns()
func (_EigenPodManagerStorage *EigenPodManagerStorageSession) DisablePod() (*types.Transaction, error) {
	return _EigenPodManagerStorage.Contract.DisablePod(&_EigenPodManagerStorage.TransactOpts)
}

// DisablePod is a paid mutator transaction binding the contract method 0x630f5323.
//
// Solidity: function disablePod() returns()
func (_EigenPodManagerStorage *EigenPodManagerStorageTransactorSession) DisablePod() (*types.Transaction, error) {
	return _EigenPodManagerStorage.Contract.DisablePod(&_EigenPodManagerStorage.TransactOpts)
}
...
func (_EigenPodManagerStorage *EigenPodManagerStorageTransactor) IncreaseBurnOrRedistributableShares(opts *bind.TransactOpts, operatorSet OperatorSet, slashId *big.Int, strategy common.Address, addedSharesToBurn *big.Int) (*types.Transaction, error) {
	return _EigenPodManagerStorage.contract.Transact(opts, "increaseBurnOrRedistributableShares", operatorSet, slashId, strategy, addedSharesToBurn)
}

// IncreaseBurnOrRedistributableShares is a paid mutator transaction binding the contract method 0x3fb99ca5.
//
// Solidity: function increaseBurnOrRedistributableShares((address,uint32) operatorSet, uint256 slashId, address strategy, uint256 addedSharesToBurn) returns()
func (_EigenPodManagerStorage *EigenPodManagerStorageSession) IncreaseBurnOrRedistributableShares(operatorSet OperatorSet, slashId *big.Int, strategy common.Address, addedSharesToBurn *big.Int) (*types.Transaction, error) {
	return _EigenPodManagerStorage.Contract.IncreaseBurnOrRedistributableShares(&_EigenPodManagerStorage.TransactOpts, operatorSet, slashId, strategy, addedSharesToBurn)
}

// IncreaseBurnOrRedistributableShares is a paid mutator transaction binding the contract method 0x3fb99ca5.
//
// Solidity: function increaseBurnOrRedistributableShares((address,uint32) operatorSet, uint256 slashId, address strategy, uint256 addedSharesToBurn) returns()
func (_EigenPodManagerStorage *EigenPodManagerStorageTransactorSession) IncreaseBurnOrRedistributableShares(operatorSet OperatorSet, slashId *big.Int, strategy common.Address, addedSharesToBurn *big.Int) (*types.Transaction, error) {
	return _EigenPodManagerStorage.Contract.IncreaseBurnOrRedistributableShares(&_EigenPodManagerStorage.TransactOpts, operatorSet, slashId, strategy, addedSharesToBurn)
}
...
// EigenPodManagerStoragePodRestakingDisabledIterator is returned from FilterPodRestakingDisabled and is used to iterate over the raw logs and unpacked data for PodRestakingDisabled events raised by the EigenPodManagerStorage contract.
type EigenPodManagerStoragePodRestakingDisabledIterator struct {
	Event *EigenPodManagerStoragePodRestakingDisabled // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *EigenPodManagerStoragePodRestakingDisabledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(EigenPodManagerStoragePodRestakingDisabled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *EigenPodManagerStoragePodRestakingDisabledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *EigenPodManagerStoragePodRestakingDisabledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// EigenPodManagerStoragePodRestakingDisabled represents a PodRestakingDisabled event raised by the EigenPodManagerStorage contract.
type EigenPodManagerStoragePodRestakingDisabled struct {
	PodOwner common.Address
	Pod      common.Address
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterPodRestakingDisabled is a free log retrieval operation binding the contract event 0xf49360efbbc18864f95ae01a5ef25596434d73f480bd0f041451e58bf1da6259.
//
// Solidity: event PodRestakingDisabled(address indexed podOwner, address indexed pod)
func (_EigenPodManagerStorage *EigenPodManagerStorageFilterer) FilterPodRestakingDisabled(opts *bind.FilterOpts, podOwner []common.Address, pod []common.Address) (*EigenPodManagerStoragePodRestakingDisabledIterator, error) {
	...
	logs, sub, err := _EigenPodManagerStorage.contract.FilterLogs(opts, "PodRestakingDisabled", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
	return &EigenPodManagerStoragePodRestakingDisabledIterator{contract: _EigenPodManagerStorage.contract, event: "PodRestakingDisabled", logs: logs, sub: sub}, nil
}

// WatchPodRestakingDisabled is a free log subscription operation binding the contract event 0xf49360efbbc18864f95ae01a5ef25596434d73f480bd0f041451e58bf1da6259.
//
// Solidity: event PodRestakingDisabled(address indexed podOwner, address indexed pod)
func (_EigenPodManagerStorage *EigenPodManagerStorageFilterer) WatchPodRestakingDisabled(opts *bind.WatchOpts, sink chan<- *EigenPodManagerStoragePodRestakingDisabled, podOwner []common.Address, pod []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _EigenPodManagerStorage.contract.WatchLogs(opts, "PodRestakingDisabled", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(EigenPodManagerStoragePodRestakingDisabled)
				if err := _EigenPodManagerStorage.contract.UnpackLog(event, "PodRestakingDisabled", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParsePodRestakingDisabled is a log parse operation binding the contract event 0xf49360efbbc18864f95ae01a5ef25596434d73f480bd0f041451e58bf1da6259.
//
// Solidity: event PodRestakingDisabled(address indexed podOwner, address indexed pod)
func (_EigenPodManagerStorage *EigenPodManagerStorageFilterer) ParsePodRestakingDisabled(log types.Log) (*EigenPodManagerStoragePodRestakingDisabled, error) {
	event := new(EigenPodManagerStoragePodRestakingDisabled)
	if err := _EigenPodManagerStorage.contract.UnpackLog(event, "PodRestakingDisabled", log); err != nil {
		return nil, err
	}
