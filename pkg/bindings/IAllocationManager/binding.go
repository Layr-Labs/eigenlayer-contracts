...
func (_IAllocationManager *IAllocationManagerCaller) ALLOCATIONCONFIGURATIONDELAY(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "ALLOCATION_CONFIGURATION_DELAY")
...
//
// Solidity: function ALLOCATION_CONFIGURATION_DELAY() view returns(uint32)
func (_IAllocationManager *IAllocationManagerSession) ALLOCATIONCONFIGURATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.ALLOCATIONCONFIGURATIONDELAY(&_IAllocationManager.CallOpts)
}

// ALLOCATIONCONFIGURATIONDELAY is a free data retrieval call binding the contract method 0x7bc1ef61.
//
// Solidity: function ALLOCATION_CONFIGURATION_DELAY() view returns(uint32)
func (_IAllocationManager *IAllocationManagerCallerSession) ALLOCATIONCONFIGURATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.ALLOCATIONCONFIGURATIONDELAY(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) DEALLOCATIONDELAY(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "DEALLOCATION_DELAY")
...
//
// Solidity: function DEALLOCATION_DELAY() view returns(uint32 delay)
func (_IAllocationManager *IAllocationManagerSession) DEALLOCATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.DEALLOCATIONDELAY(&_IAllocationManager.CallOpts)
}

// DEALLOCATIONDELAY is a free data retrieval call binding the contract method 0x2981eb77.
//
// Solidity: function DEALLOCATION_DELAY() view returns(uint32 delay)
func (_IAllocationManager *IAllocationManagerCallerSession) DEALLOCATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.DEALLOCATIONDELAY(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) SLASHERCONFIGURATIONDELAY(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "SLASHER_CONFIGURATION_DELAY")
...
//
// Solidity: function SLASHER_CONFIGURATION_DELAY() view returns(uint32)
func (_IAllocationManager *IAllocationManagerSession) SLASHERCONFIGURATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.SLASHERCONFIGURATIONDELAY(&_IAllocationManager.CallOpts)
}

// SLASHERCONFIGURATIONDELAY is a free data retrieval call binding the contract method 0x67aeaa53.
//
// Solidity: function SLASHER_CONFIGURATION_DELAY() view returns(uint32)
func (_IAllocationManager *IAllocationManagerCallerSession) SLASHERCONFIGURATIONDELAY() (uint32, error) {
	return _IAllocationManager.Contract.SLASHERCONFIGURATIONDELAY(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) Delegation(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "delegation")
...
//
// Solidity: function delegation() view returns(address)
func (_IAllocationManager *IAllocationManagerSession) Delegation() (common.Address, error) {
	return _IAllocationManager.Contract.Delegation(&_IAllocationManager.CallOpts)
}

// Delegation is a free data retrieval call binding the contract method 0xdf5cf723.
//
// Solidity: function delegation() view returns(address)
func (_IAllocationManager *IAllocationManagerCallerSession) Delegation() (common.Address, error) {
	return _IAllocationManager.Contract.Delegation(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) EigenStrategy(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "eigenStrategy")
...
//
// Solidity: function eigenStrategy() view returns(address)
func (_IAllocationManager *IAllocationManagerSession) EigenStrategy() (common.Address, error) {
	return _IAllocationManager.Contract.EigenStrategy(&_IAllocationManager.CallOpts)
}

// EigenStrategy is a free data retrieval call binding the contract method 0xdb4df761.
//
// Solidity: function eigenStrategy() view returns(address)
func (_IAllocationManager *IAllocationManagerCallerSession) EigenStrategy() (common.Address, error) {
	return _IAllocationManager.Contract.EigenStrategy(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) GetPendingSlasher(opts *bind.CallOpts, operatorSet OperatorSet) (struct {
	...
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "getPendingSlasher", operatorSet)
...
//
// Solidity: function getPendingSlasher((address,uint32) operatorSet) view returns(address pendingSlasher, uint32 effectBlock)
func (_IAllocationManager *IAllocationManagerSession) GetPendingSlasher(operatorSet OperatorSet) (struct {
	PendingSlasher common.Address
	EffectBlock    uint32
}, error) {
	return _IAllocationManager.Contract.GetPendingSlasher(&_IAllocationManager.CallOpts, operatorSet)
}

// GetPendingSlasher is a free data retrieval call binding the contract method 0xd7794857.
//
// Solidity: function getPendingSlasher((address,uint32) operatorSet) view returns(address pendingSlasher, uint32 effectBlock)
func (_IAllocationManager *IAllocationManagerCallerSession) GetPendingSlasher(operatorSet OperatorSet) (struct {
	PendingSlasher common.Address
	EffectBlock    uint32
}, error) {
	return _IAllocationManager.Contract.GetPendingSlasher(&_IAllocationManager.CallOpts, operatorSet)
...
func (_IAllocationManager *IAllocationManagerCaller) GetRedistributionRecipient(opts *bind.CallOpts, operatorSet OperatorSet) (common.Address, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "getRedistributionRecipient", operatorSet)
...
//
// Solidity: function getRedistributionRecipient((address,uint32) operatorSet) view returns(address)
func (_IAllocationManager *IAllocationManagerSession) GetRedistributionRecipient(operatorSet OperatorSet) (common.Address, error) {
	return _IAllocationManager.Contract.GetRedistributionRecipient(&_IAllocationManager.CallOpts, operatorSet)
}

// GetRedistributionRecipient is a free data retrieval call binding the contract method 0x0f3df50e.
//
// Solidity: function getRedistributionRecipient((address,uint32) operatorSet) view returns(address)
func (_IAllocationManager *IAllocationManagerCallerSession) GetRedistributionRecipient(operatorSet OperatorSet) (common.Address, error) {
	return _IAllocationManager.Contract.GetRedistributionRecipient(&_IAllocationManager.CallOpts, operatorSet)
}
...
func (_IAllocationManager *IAllocationManagerCaller) GetSlashCount(opts *bind.CallOpts, operatorSet OperatorSet) (*big.Int, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "getSlashCount", operatorSet)
...
//
// Solidity: function getSlashCount((address,uint32) operatorSet) view returns(uint256)
func (_IAllocationManager *IAllocationManagerSession) GetSlashCount(operatorSet OperatorSet) (*big.Int, error) {
	return _IAllocationManager.Contract.GetSlashCount(&_IAllocationManager.CallOpts, operatorSet)
}

// GetSlashCount is a free data retrieval call binding the contract method 0x4cfd2939.
//
// Solidity: function getSlashCount((address,uint32) operatorSet) view returns(uint256)
func (_IAllocationManager *IAllocationManagerCallerSession) GetSlashCount(operatorSet OperatorSet) (*big.Int, error) {
	return _IAllocationManager.Contract.GetSlashCount(&_IAllocationManager.CallOpts, operatorSet)
}
...
func (_IAllocationManager *IAllocationManagerCaller) GetSlasher(opts *bind.CallOpts, operatorSet OperatorSet) (common.Address, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "getSlasher", operatorSet)
...
//
// Solidity: function getSlasher((address,uint32) operatorSet) view returns(address)
func (_IAllocationManager *IAllocationManagerSession) GetSlasher(operatorSet OperatorSet) (common.Address, error) {
	return _IAllocationManager.Contract.GetSlasher(&_IAllocationManager.CallOpts, operatorSet)
}

// GetSlasher is a free data retrieval call binding the contract method 0xd4a3fcce.
//
// Solidity: function getSlasher((address,uint32) operatorSet) view returns(address)
func (_IAllocationManager *IAllocationManagerCallerSession) GetSlasher(operatorSet OperatorSet) (common.Address, error) {
	return _IAllocationManager.Contract.GetSlasher(&_IAllocationManager.CallOpts, operatorSet)
}
...
func (_IAllocationManager *IAllocationManagerCaller) IsOperatorRedistributable(opts *bind.CallOpts, operator common.Address) (bool, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "isOperatorRedistributable", operator)
...
//
// Solidity: function isOperatorRedistributable(address operator) view returns(bool)
func (_IAllocationManager *IAllocationManagerSession) IsOperatorRedistributable(operator common.Address) (bool, error) {
	return _IAllocationManager.Contract.IsOperatorRedistributable(&_IAllocationManager.CallOpts, operator)
}

// IsOperatorRedistributable is a free data retrieval call binding the contract method 0xdc2af692.
//
// Solidity: function isOperatorRedistributable(address operator) view returns(bool)
func (_IAllocationManager *IAllocationManagerCallerSession) IsOperatorRedistributable(operator common.Address) (bool, error) {
	return _IAllocationManager.Contract.IsOperatorRedistributable(&_IAllocationManager.CallOpts, operator)
}
...
func (_IAllocationManager *IAllocationManagerCaller) IsRedistributingOperatorSet(opts *bind.CallOpts, operatorSet OperatorSet) (bool, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "isRedistributingOperatorSet", operatorSet)
...
//
// Solidity: function isRedistributingOperatorSet((address,uint32) operatorSet) view returns(bool)
func (_IAllocationManager *IAllocationManagerSession) IsRedistributingOperatorSet(operatorSet OperatorSet) (bool, error) {
	return _IAllocationManager.Contract.IsRedistributingOperatorSet(&_IAllocationManager.CallOpts, operatorSet)
}

// IsRedistributingOperatorSet is a free data retrieval call binding the contract method 0xf231bd08.
//
// Solidity: function isRedistributingOperatorSet((address,uint32) operatorSet) view returns(bool)
func (_IAllocationManager *IAllocationManagerCallerSession) IsRedistributingOperatorSet(operatorSet OperatorSet) (bool, error) {
	return _IAllocationManager.Contract.IsRedistributingOperatorSet(&_IAllocationManager.CallOpts, operatorSet)
}
...
func (_IAllocationManager *IAllocationManagerCaller) Paused(opts *bind.CallOpts, index uint8) (bool, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "paused", index)
...
//
// Solidity: function paused(uint8 index) view returns(bool)
func (_IAllocationManager *IAllocationManagerSession) Paused(index uint8) (bool, error) {
	return _IAllocationManager.Contract.Paused(&_IAllocationManager.CallOpts, index)
}

// Paused is a free data retrieval call binding the contract method 0x5ac86ab7.
//
// Solidity: function paused(uint8 index) view returns(bool)
func (_IAllocationManager *IAllocationManagerCallerSession) Paused(index uint8) (bool, error) {
	return _IAllocationManager.Contract.Paused(&_IAllocationManager.CallOpts, index)
}
...
func (_IAllocationManager *IAllocationManagerCaller) Paused0(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "paused0")
...
//
// Solidity: function paused() view returns(uint256)
func (_IAllocationManager *IAllocationManagerSession) Paused0() (*big.Int, error) {
	return _IAllocationManager.Contract.Paused0(&_IAllocationManager.CallOpts)
}

// Paused0 is a free data retrieval call binding the contract method 0x5c975abb.
//
// Solidity: function paused() view returns(uint256)
func (_IAllocationManager *IAllocationManagerCallerSession) Paused0() (*big.Int, error) {
	return _IAllocationManager.Contract.Paused0(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerCaller) PauserRegistry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IAllocationManager.contract.Call(opts, &out, "pauserRegistry")
...
//
// Solidity: function pauserRegistry() view returns(address)
func (_IAllocationManager *IAllocationManagerSession) PauserRegistry() (common.Address, error) {
	return _IAllocationManager.Contract.PauserRegistry(&_IAllocationManager.CallOpts)
}

// PauserRegistry is a free data retrieval call binding the contract method 0x886f1195.
//
// Solidity: function pauserRegistry() view returns(address)
func (_IAllocationManager *IAllocationManagerCallerSession) PauserRegistry() (common.Address, error) {
	return _IAllocationManager.Contract.PauserRegistry(&_IAllocationManager.CallOpts)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) CreateOperatorSets0(opts *bind.TransactOpts, avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "createOperatorSets0", avs, params)
}

// CreateOperatorSets0 is a paid mutator transaction binding the contract method 0x3dff8e7d.
//
// Solidity: function createOperatorSets(address avs, (uint32,address[],address)[] params) returns()
func (_IAllocationManager *IAllocationManagerSession) CreateOperatorSets0(avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateOperatorSets0(&_IAllocationManager.TransactOpts, avs, params)
}

// CreateOperatorSets0 is a paid mutator transaction binding the contract method 0x3dff8e7d.
//
// Solidity: function createOperatorSets(address avs, (uint32,address[],address)[] params) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) CreateOperatorSets0(avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateOperatorSets0(&_IAllocationManager.TransactOpts, avs, params)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) CreateRedistributingOperatorSets(opts *bind.TransactOpts, avs common.Address, params []IAllocationManagerTypesCreateSetParams, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "createRedistributingOperatorSets", avs, params, redistributionRecipients)
}

// CreateRedistributingOperatorSets is a paid mutator transaction binding the contract method 0x32a879e4.
//
// Solidity: function createRedistributingOperatorSets(address avs, (uint32,address[])[] params, address[] redistributionRecipients) returns()
func (_IAllocationManager *IAllocationManagerSession) CreateRedistributingOperatorSets(avs common.Address, params []IAllocationManagerTypesCreateSetParams, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateRedistributingOperatorSets(&_IAllocationManager.TransactOpts, avs, params, redistributionRecipients)
}

// CreateRedistributingOperatorSets is a paid mutator transaction binding the contract method 0x32a879e4.
//
// Solidity: function createRedistributingOperatorSets(address avs, (uint32,address[])[] params, address[] redistributionRecipients) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) CreateRedistributingOperatorSets(avs common.Address, params []IAllocationManagerTypesCreateSetParams, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateRedistributingOperatorSets(&_IAllocationManager.TransactOpts, avs, params, redistributionRecipients)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) CreateRedistributingOperatorSets0(opts *bind.TransactOpts, avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "createRedistributingOperatorSets0", avs, params, redistributionRecipients)
}

// CreateRedistributingOperatorSets0 is a paid mutator transaction binding the contract method 0xd1a83f54.
//
// Solidity: function createRedistributingOperatorSets(address avs, (uint32,address[],address)[] params, address[] redistributionRecipients) returns()
func (_IAllocationManager *IAllocationManagerSession) CreateRedistributingOperatorSets0(avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateRedistributingOperatorSets0(&_IAllocationManager.TransactOpts, avs, params, redistributionRecipients)
}

// CreateRedistributingOperatorSets0 is a paid mutator transaction binding the contract method 0xd1a83f54.
//
// Solidity: function createRedistributingOperatorSets(address avs, (uint32,address[],address)[] params, address[] redistributionRecipients) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) CreateRedistributingOperatorSets0(avs common.Address, params []IAllocationManagerTypesCreateSetParamsV2, redistributionRecipients []common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.CreateRedistributingOperatorSets0(&_IAllocationManager.TransactOpts, avs, params, redistributionRecipients)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) Initialize(opts *bind.TransactOpts, initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "initialize", initialPausedStatus)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerSession) Initialize(initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Initialize(&_IAllocationManager.TransactOpts, initialPausedStatus)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) Initialize(initialPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Initialize(&_IAllocationManager.TransactOpts, initialPausedStatus)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) MigrateSlashers(opts *bind.TransactOpts, operatorSets []OperatorSet) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "migrateSlashers", operatorSets)
}

// MigrateSlashers is a paid mutator transaction binding the contract method 0x957dc50b.
//
// Solidity: function migrateSlashers((address,uint32)[] operatorSets) returns()
func (_IAllocationManager *IAllocationManagerSession) MigrateSlashers(operatorSets []OperatorSet) (*types.Transaction, error) {
	return _IAllocationManager.Contract.MigrateSlashers(&_IAllocationManager.TransactOpts, operatorSets)
}

// MigrateSlashers is a paid mutator transaction binding the contract method 0x957dc50b.
//
// Solidity: function migrateSlashers((address,uint32)[] operatorSets) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) MigrateSlashers(operatorSets []OperatorSet) (*types.Transaction, error) {
	return _IAllocationManager.Contract.MigrateSlashers(&_IAllocationManager.TransactOpts, operatorSets)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) Pause(opts *bind.TransactOpts, newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "pause", newPausedStatus)
}

// Pause is a paid mutator transaction binding the contract method 0x136439dd.
//
// Solidity: function pause(uint256 newPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerSession) Pause(newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Pause(&_IAllocationManager.TransactOpts, newPausedStatus)
}

// Pause is a paid mutator transaction binding the contract method 0x136439dd.
//
// Solidity: function pause(uint256 newPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) Pause(newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Pause(&_IAllocationManager.TransactOpts, newPausedStatus)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) PauseAll(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "pauseAll")
}

// PauseAll is a paid mutator transaction binding the contract method 0x595c6a67.
//
// Solidity: function pauseAll() returns()
func (_IAllocationManager *IAllocationManagerSession) PauseAll() (*types.Transaction, error) {
	return _IAllocationManager.Contract.PauseAll(&_IAllocationManager.TransactOpts)
}

// PauseAll is a paid mutator transaction binding the contract method 0x595c6a67.
//
// Solidity: function pauseAll() returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) PauseAll() (*types.Transaction, error) {
	return _IAllocationManager.Contract.PauseAll(&_IAllocationManager.TransactOpts)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) Unpause(opts *bind.TransactOpts, newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "unpause", newPausedStatus)
}

// Unpause is a paid mutator transaction binding the contract method 0xfabc1cbc.
//
// Solidity: function unpause(uint256 newPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerSession) Unpause(newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Unpause(&_IAllocationManager.TransactOpts, newPausedStatus)
}

// Unpause is a paid mutator transaction binding the contract method 0xfabc1cbc.
//
// Solidity: function unpause(uint256 newPausedStatus) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) Unpause(newPausedStatus *big.Int) (*types.Transaction, error) {
	return _IAllocationManager.Contract.Unpause(&_IAllocationManager.TransactOpts, newPausedStatus)
}
...
func (_IAllocationManager *IAllocationManagerTransactor) UpdateSlasher(opts *bind.TransactOpts, operatorSet OperatorSet, slasher common.Address) (*types.Transaction, error) {
	return _IAllocationManager.contract.Transact(opts, "updateSlasher", operatorSet, slasher)
}

// UpdateSlasher is a paid mutator transaction binding the contract method 0x6c9d7c58.
//
// Solidity: function updateSlasher((address,uint32) operatorSet, address slasher) returns()
func (_IAllocationManager *IAllocationManagerSession) UpdateSlasher(operatorSet OperatorSet, slasher common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.UpdateSlasher(&_IAllocationManager.TransactOpts, operatorSet, slasher)
}

// UpdateSlasher is a paid mutator transaction binding the contract method 0x6c9d7c58.
//
// Solidity: function updateSlasher((address,uint32) operatorSet, address slasher) returns()
func (_IAllocationManager *IAllocationManagerTransactorSession) UpdateSlasher(operatorSet OperatorSet, slasher common.Address) (*types.Transaction, error) {
	return _IAllocationManager.Contract.UpdateSlasher(&_IAllocationManager.TransactOpts, operatorSet, slasher)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAllocationManagerPausedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAllocationManagerPaused)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAllocationManagerPausedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAllocationManagerPausedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) FilterPaused(opts *bind.FilterOpts, account []common.Address) (*IAllocationManagerPausedIterator, error) {
	...
	logs, sub, err := _IAllocationManager.contract.FilterLogs(opts, "Paused", accountRule)
	if err != nil {
		return nil, err
	}
	return &IAllocationManagerPausedIterator{contract: _IAllocationManager.contract, event: "Paused", logs: logs, sub: sub}, nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) WatchPaused(opts *bind.WatchOpts, sink chan<- *IAllocationManagerPaused, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IAllocationManager.contract.WatchLogs(opts, "Paused", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAllocationManagerPaused)
				if err := _IAllocationManager.contract.UnpackLog(event, "Paused", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAllocationManagerRedistributionAddressSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAllocationManagerRedistributionAddressSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAllocationManagerRedistributionAddressSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAllocationManagerRedistributionAddressSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) FilterRedistributionAddressSet(opts *bind.FilterOpts) (*IAllocationManagerRedistributionAddressSetIterator, error) {
	...
	logs, sub, err := _IAllocationManager.contract.FilterLogs(opts, "RedistributionAddressSet")
	if err != nil {
		return nil, err
	}
	return &IAllocationManagerRedistributionAddressSetIterator{contract: _IAllocationManager.contract, event: "RedistributionAddressSet", logs: logs, sub: sub}, nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) WatchRedistributionAddressSet(opts *bind.WatchOpts, sink chan<- *IAllocationManagerRedistributionAddressSet) (event.Subscription, error) {
	...
	logs, sub, err := _IAllocationManager.contract.WatchLogs(opts, "RedistributionAddressSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAllocationManagerRedistributionAddressSet)
				if err := _IAllocationManager.contract.UnpackLog(event, "RedistributionAddressSet", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAllocationManagerSlasherMigratedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAllocationManagerSlasherMigrated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAllocationManagerSlasherMigratedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAllocationManagerSlasherMigratedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) FilterSlasherMigrated(opts *bind.FilterOpts) (*IAllocationManagerSlasherMigratedIterator, error) {
	...
	logs, sub, err := _IAllocationManager.contract.FilterLogs(opts, "SlasherMigrated")
	if err != nil {
		return nil, err
	}
	return &IAllocationManagerSlasherMigratedIterator{contract: _IAllocationManager.contract, event: "SlasherMigrated", logs: logs, sub: sub}, nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) WatchSlasherMigrated(opts *bind.WatchOpts, sink chan<- *IAllocationManagerSlasherMigrated) (event.Subscription, error) {
	...
	logs, sub, err := _IAllocationManager.contract.WatchLogs(opts, "SlasherMigrated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAllocationManagerSlasherMigrated)
				if err := _IAllocationManager.contract.UnpackLog(event, "SlasherMigrated", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAllocationManagerSlasherUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAllocationManagerSlasherUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAllocationManagerSlasherUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAllocationManagerSlasherUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) FilterSlasherUpdated(opts *bind.FilterOpts) (*IAllocationManagerSlasherUpdatedIterator, error) {
	...
	logs, sub, err := _IAllocationManager.contract.FilterLogs(opts, "SlasherUpdated")
	if err != nil {
		return nil, err
	}
	return &IAllocationManagerSlasherUpdatedIterator{contract: _IAllocationManager.contract, event: "SlasherUpdated", logs: logs, sub: sub}, nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) WatchSlasherUpdated(opts *bind.WatchOpts, sink chan<- *IAllocationManagerSlasherUpdated) (event.Subscription, error) {
	...
	logs, sub, err := _IAllocationManager.contract.WatchLogs(opts, "SlasherUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAllocationManagerSlasherUpdated)
				if err := _IAllocationManager.contract.UnpackLog(event, "SlasherUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IAllocationManagerUnpausedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAllocationManagerUnpaused)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IAllocationManagerUnpausedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IAllocationManagerUnpausedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) FilterUnpaused(opts *bind.FilterOpts, account []common.Address) (*IAllocationManagerUnpausedIterator, error) {
	...
	logs, sub, err := _IAllocationManager.contract.FilterLogs(opts, "Unpaused", accountRule)
	if err != nil {
		return nil, err
	}
	return &IAllocationManagerUnpausedIterator{contract: _IAllocationManager.contract, event: "Unpaused", logs: logs, sub: sub}, nil
}
...
func (_IAllocationManager *IAllocationManagerFilterer) WatchUnpaused(opts *bind.WatchOpts, sink chan<- *IAllocationManagerUnpaused, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IAllocationManager.contract.WatchLogs(opts, "Unpaused", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IAllocationManagerUnpaused)
				if err := _IAllocationManager.contract.UnpackLog(event, "Unpaused", log); err != nil {
					return err
				}
				event.Raw = log
