...
func (_TaskMailboxStorage *TaskMailboxStorageCaller) MAXTASKSLA(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TaskMailboxStorage.contract.Call(opts, &out, "MAX_TASK_SLA")
...
//
// Solidity: function MAX_TASK_SLA() view returns(uint96)
func (_TaskMailboxStorage *TaskMailboxStorageSession) MAXTASKSLA() (*big.Int, error) {
	return _TaskMailboxStorage.Contract.MAXTASKSLA(&_TaskMailboxStorage.CallOpts)
}

// MAXTASKSLA is a free data retrieval call binding the contract method 0xd3e043aa.
//
// Solidity: function MAX_TASK_SLA() view returns(uint96)
func (_TaskMailboxStorage *TaskMailboxStorageCallerSession) MAXTASKSLA() (*big.Int, error) {
	return _TaskMailboxStorage.Contract.MAXTASKSLA(&_TaskMailboxStorage.CallOpts)
}
...
func (_TaskMailboxStorage *TaskMailboxStorageCaller) GetMessageHash(opts *bind.CallOpts, taskHash [32]byte, result []byte) ([32]byte, error) {
	var out []interface{}
	err := _TaskMailboxStorage.contract.Call(opts, &out, "getMessageHash", taskHash, result)
...
//
// Solidity: function getMessageHash(bytes32 taskHash, bytes result) pure returns(bytes32)
func (_TaskMailboxStorage *TaskMailboxStorageSession) GetMessageHash(taskHash [32]byte, result []byte) ([32]byte, error) {
	return _TaskMailboxStorage.Contract.GetMessageHash(&_TaskMailboxStorage.CallOpts, taskHash, result)
}

// GetMessageHash is a free data retrieval call binding the contract method 0x37eaa104.
//
// Solidity: function getMessageHash(bytes32 taskHash, bytes result) pure returns(bytes32)
func (_TaskMailboxStorage *TaskMailboxStorageCallerSession) GetMessageHash(taskHash [32]byte, result []byte) ([32]byte, error) {
	return _TaskMailboxStorage.Contract.GetMessageHash(&_TaskMailboxStorage.CallOpts, taskHash, result)
}
