...
func (_AVSDirectoryStorage *AVSDirectoryStorageTransactor) DeregisterFromAVSOperatorSets(opts *bind.TransactOpts, avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.contract.Transact(opts, "deregisterFromAVSOperatorSets", avs, operatorSetIds)
}

// DeregisterFromAVSOperatorSets is a paid mutator transaction binding the contract method 0x9c6c5184.
//
// Solidity: function deregisterFromAVSOperatorSets(address avs, uint32[] operatorSetIds) returns()
func (_AVSDirectoryStorage *AVSDirectoryStorageSession) DeregisterFromAVSOperatorSets(avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.Contract.DeregisterFromAVSOperatorSets(&_AVSDirectoryStorage.TransactOpts, avs, operatorSetIds)
}

// DeregisterFromAVSOperatorSets is a paid mutator transaction binding the contract method 0x9c6c5184.
//
// Solidity: function deregisterFromAVSOperatorSets(address avs, uint32[] operatorSetIds) returns()
func (_AVSDirectoryStorage *AVSDirectoryStorageTransactorSession) DeregisterFromAVSOperatorSets(avs common.Address, operatorSetIds []uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.Contract.DeregisterFromAVSOperatorSets(&_AVSDirectoryStorage.TransactOpts, avs, operatorSetIds)
}
