...
func (_AVSDirectoryStorage *AVSDirectoryStorageCaller) DEALLOCATIONDELAY(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _AVSDirectoryStorage.contract.Call(opts, &out, "DEALLOCATION_DELAY")
...
//
// Solidity: function DEALLOCATION_DELAY() view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageSession) DEALLOCATIONDELAY() (uint32, error) {
	return _AVSDirectoryStorage.Contract.DEALLOCATIONDELAY(&_AVSDirectoryStorage.CallOpts)
}

// DEALLOCATIONDELAY is a free data retrieval call binding the contract method 0x2981eb77.
//
// Solidity: function DEALLOCATION_DELAY() view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageCallerSession) DEALLOCATIONDELAY() (uint32, error) {
	return _AVSDirectoryStorage.Contract.DEALLOCATIONDELAY(&_AVSDirectoryStorage.CallOpts)
}
...
// LatestAllocationEffectTimestamp is a free data retrieval call binding the contract method 0x5bf4fdbf.
//
// Solidity: function latestAllocationEffectTimestamp(address ) view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageCaller) LatestAllocationEffectTimestamp(opts *bind.CallOpts, arg0 common.Address) (uint32, error) {
	var out []interface{}
	err := _AVSDirectoryStorage.contract.Call(opts, &out, "latestAllocationEffectTimestamp", arg0)
...
//
// Solidity: function latestAllocationEffectTimestamp(address ) view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageSession) LatestAllocationEffectTimestamp(arg0 common.Address) (uint32, error) {
	return _AVSDirectoryStorage.Contract.LatestAllocationEffectTimestamp(&_AVSDirectoryStorage.CallOpts, arg0)
}

// LatestAllocationEffectTimestamp is a free data retrieval call binding the contract method 0x5bf4fdbf.
//
// Solidity: function latestAllocationEffectTimestamp(address ) view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageCallerSession) LatestAllocationEffectTimestamp(arg0 common.Address) (uint32, error) {
	return _AVSDirectoryStorage.Contract.LatestAllocationEffectTimestamp(&_AVSDirectoryStorage.CallOpts, arg0)
}
...
func (_AVSDirectoryStorage *AVSDirectoryStorageCaller) OperatorAllocationDelay(opts *bind.CallOpts, operator common.Address) (uint32, error) {
	var out []interface{}
	err := _AVSDirectoryStorage.contract.Call(opts, &out, "operatorAllocationDelay", operator)
...
//
// Solidity: function operatorAllocationDelay(address operator) view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageSession) OperatorAllocationDelay(operator common.Address) (uint32, error) {
	return _AVSDirectoryStorage.Contract.OperatorAllocationDelay(&_AVSDirectoryStorage.CallOpts, operator)
}

// OperatorAllocationDelay is a free data retrieval call binding the contract method 0x89829397.
//
// Solidity: function operatorAllocationDelay(address operator) view returns(uint32)
func (_AVSDirectoryStorage *AVSDirectoryStorageCallerSession) OperatorAllocationDelay(operator common.Address) (uint32, error) {
	return _AVSDirectoryStorage.Contract.OperatorAllocationDelay(&_AVSDirectoryStorage.CallOpts, operator)
}
...
func (_AVSDirectoryStorage *AVSDirectoryStorageTransactor) SetAllocationDelay(opts *bind.TransactOpts, delay uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.contract.Transact(opts, "setAllocationDelay", delay)
}

// SetAllocationDelay is a paid mutator transaction binding the contract method 0x5c489bb5.
//
// Solidity: function setAllocationDelay(uint32 delay) returns()
func (_AVSDirectoryStorage *AVSDirectoryStorageSession) SetAllocationDelay(delay uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.Contract.SetAllocationDelay(&_AVSDirectoryStorage.TransactOpts, delay)
}

// SetAllocationDelay is a paid mutator transaction binding the contract method 0x5c489bb5.
//
// Solidity: function setAllocationDelay(uint32 delay) returns()
func (_AVSDirectoryStorage *AVSDirectoryStorageTransactorSession) SetAllocationDelay(delay uint32) (*types.Transaction, error) {
	return _AVSDirectoryStorage.Contract.SetAllocationDelay(&_AVSDirectoryStorage.TransactOpts, delay)
}
