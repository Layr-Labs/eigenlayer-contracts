...
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCaller) GetOperatorInfo(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint32 operatorIndex) view returns((address,uint256[]))
func (_IECDSACertificateVerifier *IECDSACertificateVerifierSession) GetOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
...
//
// Solidity: function getOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint32 operatorIndex) view returns((address,uint256[]))
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCallerSession) GetOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
	return _IECDSACertificateVerifier.Contract.GetOperatorInfo(&_IECDSACertificateVerifier.CallOpts, operatorSet, referenceTimestamp, operatorIndex)
}
...
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCaller) GetOperatorInfos(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32) ([]IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorInfos((address,uint32) operatorSet, uint32 referenceTimestamp) view returns((address,uint256[])[])
func (_IECDSACertificateVerifier *IECDSACertificateVerifierSession) GetOperatorInfos(operatorSet OperatorSet, referenceTimestamp uint32) ([]IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
...
//
// Solidity: function getOperatorInfos((address,uint32) operatorSet, uint32 referenceTimestamp) view returns((address,uint256[])[])
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCallerSession) GetOperatorInfos(operatorSet OperatorSet, referenceTimestamp uint32) ([]IECDSATableCalculatorTypesECDSAOperatorInfo, error) {
	return _IECDSACertificateVerifier.Contract.GetOperatorInfos(&_IECDSACertificateVerifier.CallOpts, operatorSet, referenceTimestamp)
}
