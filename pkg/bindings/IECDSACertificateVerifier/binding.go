...
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCaller) GetOperatorInfo(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IOperatorTableCalculatorTypesECDSAOperatorInfo, error) {
	var out []interface{}
...
//
// Solidity: function getOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint32 operatorIndex) view returns((address,uint256[]))
func (_IECDSACertificateVerifier *IECDSACertificateVerifierSession) GetOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IOperatorTableCalculatorTypesECDSAOperatorInfo, error) {
...
//
// Solidity: function getOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint32 operatorIndex) view returns((address,uint256[]))
func (_IECDSACertificateVerifier *IECDSACertificateVerifierCallerSession) GetOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex uint32) (IOperatorTableCalculatorTypesECDSAOperatorInfo, error) {
	return _IECDSACertificateVerifier.Contract.GetOperatorInfo(&_IECDSACertificateVerifier.CallOpts, operatorSet, referenceTimestamp, operatorIndex)
}
