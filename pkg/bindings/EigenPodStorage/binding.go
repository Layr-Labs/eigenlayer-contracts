...
func (_EigenPodStorage *EigenPodStorageCaller) RestakingDisabled(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _EigenPodStorage.contract.Call(opts, &out, "restakingDisabled")
...
//
// Solidity: function restakingDisabled() view returns(bool)
func (_EigenPodStorage *EigenPodStorageSession) RestakingDisabled() (bool, error) {
	return _EigenPodStorage.Contract.RestakingDisabled(&_EigenPodStorage.CallOpts)
}

// RestakingDisabled is a free data retrieval call binding the contract method 0xc452eeec.
//
// Solidity: function restakingDisabled() view returns(bool)
func (_EigenPodStorage *EigenPodStorageCallerSession) RestakingDisabled() (bool, error) {
	return _EigenPodStorage.Contract.RestakingDisabled(&_EigenPodStorage.CallOpts)
}
...
func (_EigenPodStorage *EigenPodStorageTransactor) DisableRestaking(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _EigenPodStorage.contract.Transact(opts, "disableRestaking")
}

// DisableRestaking is a paid mutator transaction binding the contract method 0x566f95fa.
//
// Solidity: function disableRestaking() returns()
func (_EigenPodStorage *EigenPodStorageSession) DisableRestaking() (*types.Transaction, error) {
	return _EigenPodStorage.Contract.DisableRestaking(&_EigenPodStorage.TransactOpts)
}

// DisableRestaking is a paid mutator transaction binding the contract method 0x566f95fa.
//
// Solidity: function disableRestaking() returns()
func (_EigenPodStorage *EigenPodStorageTransactorSession) DisableRestaking() (*types.Transaction, error) {
	return _EigenPodStorage.Contract.DisableRestaking(&_EigenPodStorage.TransactOpts)
}
...
func (_EigenPodStorage *EigenPodStorageTransactor) WithdrawDisabledPodETH(opts *bind.TransactOpts, recipient common.Address) (*types.Transaction, error) {
	return _EigenPodStorage.contract.Transact(opts, "withdrawDisabledPodETH", recipient)
}

// WithdrawDisabledPodETH is a paid mutator transaction binding the contract method 0x8842752c.
//
// Solidity: function withdrawDisabledPodETH(address recipient) returns()
func (_EigenPodStorage *EigenPodStorageSession) WithdrawDisabledPodETH(recipient common.Address) (*types.Transaction, error) {
	return _EigenPodStorage.Contract.WithdrawDisabledPodETH(&_EigenPodStorage.TransactOpts, recipient)
}

// WithdrawDisabledPodETH is a paid mutator transaction binding the contract method 0x8842752c.
//
// Solidity: function withdrawDisabledPodETH(address recipient) returns()
func (_EigenPodStorage *EigenPodStorageTransactorSession) WithdrawDisabledPodETH(recipient common.Address) (*types.Transaction, error) {
	return _EigenPodStorage.Contract.WithdrawDisabledPodETH(&_EigenPodStorage.TransactOpts, recipient)
}
...
// EigenPodStorageDisabledPodETHWithdrawnIterator is returned from FilterDisabledPodETHWithdrawn and is used to iterate over the raw logs and unpacked data for DisabledPodETHWithdrawn events raised by the EigenPodStorage contract.
type EigenPodStorageDisabledPodETHWithdrawnIterator struct {
	Event *EigenPodStorageDisabledPodETHWithdrawn // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *EigenPodStorageDisabledPodETHWithdrawnIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(EigenPodStorageDisabledPodETHWithdrawn)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *EigenPodStorageDisabledPodETHWithdrawnIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *EigenPodStorageDisabledPodETHWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// EigenPodStorageDisabledPodETHWithdrawn represents a DisabledPodETHWithdrawn event raised by the EigenPodStorage contract.
type EigenPodStorageDisabledPodETHWithdrawn struct {
...
func (_EigenPodStorage *EigenPodStorageFilterer) FilterDisabledPodETHWithdrawn(opts *bind.FilterOpts, recipient []common.Address) (*EigenPodStorageDisabledPodETHWithdrawnIterator, error) {
	...
	logs, sub, err := _EigenPodStorage.contract.FilterLogs(opts, "DisabledPodETHWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return &EigenPodStorageDisabledPodETHWithdrawnIterator{contract: _EigenPodStorage.contract, event: "DisabledPodETHWithdrawn", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DisabledPodETHWithdrawn(address indexed recipient, uint256 amountWei)
func (_EigenPodStorage *EigenPodStorageFilterer) WatchDisabledPodETHWithdrawn(opts *bind.WatchOpts, sink chan<- *EigenPodStorageDisabledPodETHWithdrawn, recipient []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _EigenPodStorage.contract.WatchLogs(opts, "DisabledPodETHWithdrawn", recipientRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(EigenPodStorageDisabledPodETHWithdrawn)
				if err := _EigenPodStorage.contract.UnpackLog(event, "DisabledPodETHWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DisabledPodETHWithdrawn(address indexed recipient, uint256 amountWei)
func (_EigenPodStorage *EigenPodStorageFilterer) ParseDisabledPodETHWithdrawn(log types.Log) (*EigenPodStorageDisabledPodETHWithdrawn, error) {
	event := new(EigenPodStorageDisabledPodETHWithdrawn)
	if err := _EigenPodStorage.contract.UnpackLog(event, "DisabledPodETHWithdrawn", log); err != nil {
		return nil, err
	}
...
// EigenPodStorageRestakingPermanentlyDisabledIterator is returned from FilterRestakingPermanentlyDisabled and is used to iterate over the raw logs and unpacked data for RestakingPermanentlyDisabled events raised by the EigenPodStorage contract.
type EigenPodStorageRestakingPermanentlyDisabledIterator struct {
	Event *EigenPodStorageRestakingPermanentlyDisabled // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *EigenPodStorageRestakingPermanentlyDisabledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(EigenPodStorageRestakingPermanentlyDisabled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *EigenPodStorageRestakingPermanentlyDisabledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *EigenPodStorageRestakingPermanentlyDisabledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// EigenPodStorageRestakingPermanentlyDisabled represents a RestakingPermanentlyDisabled event raised by the EigenPodStorage contract.
type EigenPodStorageRestakingPermanentlyDisabled struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_EigenPodStorage *EigenPodStorageFilterer) FilterRestakingPermanentlyDisabled(opts *bind.FilterOpts) (*EigenPodStorageRestakingPermanentlyDisabledIterator, error) {

	logs, sub, err := _EigenPodStorage.contract.FilterLogs(opts, "RestakingPermanentlyDisabled")
	if err != nil {
		return nil, err
	}
	return &EigenPodStorageRestakingPermanentlyDisabledIterator{contract: _EigenPodStorage.contract, event: "RestakingPermanentlyDisabled", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event RestakingPermanentlyDisabled()
func (_EigenPodStorage *EigenPodStorageFilterer) WatchRestakingPermanentlyDisabled(opts *bind.WatchOpts, sink chan<- *EigenPodStorageRestakingPermanentlyDisabled) (event.Subscription, error) {

	logs, sub, err := _EigenPodStorage.contract.WatchLogs(opts, "RestakingPermanentlyDisabled")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(EigenPodStorageRestakingPermanentlyDisabled)
				if err := _EigenPodStorage.contract.UnpackLog(event, "RestakingPermanentlyDisabled", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event RestakingPermanentlyDisabled()
func (_EigenPodStorage *EigenPodStorageFilterer) ParseRestakingPermanentlyDisabled(log types.Log) (*EigenPodStorageRestakingPermanentlyDisabled, error) {
	event := new(EigenPodStorageRestakingPermanentlyDisabled)
	if err := _EigenPodStorage.contract.UnpackLog(event, "RestakingPermanentlyDisabled", log); err != nil {
		return nil, err
	}
