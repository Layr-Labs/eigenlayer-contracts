...
func (_EigenPodStorage *EigenPodStorageCaller) HasRestaked(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _EigenPodStorage.contract.Call(opts, &out, "hasRestaked")
...
//
// Solidity: function hasRestaked() view returns(bool)
func (_EigenPodStorage *EigenPodStorageSession) HasRestaked() (bool, error) {
	return _EigenPodStorage.Contract.HasRestaked(&_EigenPodStorage.CallOpts)
}

// HasRestaked is a free data retrieval call binding the contract method 0x3106ab53.
//
// Solidity: function hasRestaked() view returns(bool)
func (_EigenPodStorage *EigenPodStorageCallerSession) HasRestaked() (bool, error) {
	return _EigenPodStorage.Contract.HasRestaked(&_EigenPodStorage.CallOpts)
}
...
func (_EigenPodStorage *EigenPodStorageCaller) MostRecentWithdrawalTimestamp(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _EigenPodStorage.contract.Call(opts, &out, "mostRecentWithdrawalTimestamp")
...
//
// Solidity: function mostRecentWithdrawalTimestamp() view returns(uint64)
func (_EigenPodStorage *EigenPodStorageSession) MostRecentWithdrawalTimestamp() (uint64, error) {
	return _EigenPodStorage.Contract.MostRecentWithdrawalTimestamp(&_EigenPodStorage.CallOpts)
}

// MostRecentWithdrawalTimestamp is a free data retrieval call binding the contract method 0x87e0d289.
//
// Solidity: function mostRecentWithdrawalTimestamp() view returns(uint64)
func (_EigenPodStorage *EigenPodStorageCallerSession) MostRecentWithdrawalTimestamp() (uint64, error) {
	return _EigenPodStorage.Contract.MostRecentWithdrawalTimestamp(&_EigenPodStorage.CallOpts)
}
...
func (_EigenPodStorage *EigenPodStorageTransactor) ActivateRestaking(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _EigenPodStorage.contract.Transact(opts, "activateRestaking")
}

// ActivateRestaking is a paid mutator transaction binding the contract method 0x0cd4649e.
//
// Solidity: function activateRestaking() returns()
func (_EigenPodStorage *EigenPodStorageSession) ActivateRestaking() (*types.Transaction, error) {
	return _EigenPodStorage.Contract.ActivateRestaking(&_EigenPodStorage.TransactOpts)
}

// ActivateRestaking is a paid mutator transaction binding the contract method 0x0cd4649e.
//
// Solidity: function activateRestaking() returns()
func (_EigenPodStorage *EigenPodStorageTransactorSession) ActivateRestaking() (*types.Transaction, error) {
	return _EigenPodStorage.Contract.ActivateRestaking(&_EigenPodStorage.TransactOpts)
}
...
func (_EigenPodStorage *EigenPodStorageTransactor) VerifyCheckpointProofs(opts *bind.TransactOpts, stateRootProof BeaconChainProofsStateRootProof, proofs []BeaconChainProofsBalanceProof) (*types.Transaction, error) {
	return _EigenPodStorage.contract.Transact(opts, "verifyCheckpointProofs", stateRootProof, proofs)
}

// VerifyCheckpointProofs is a paid mutator transaction binding the contract method 0xf074ba62.
//
// Solidity: function verifyCheckpointProofs((bytes32,bytes) stateRootProof, (bytes32,bytes32,bytes)[] proofs) returns()
func (_EigenPodStorage *EigenPodStorageSession) VerifyCheckpointProofs(stateRootProof BeaconChainProofsStateRootProof, proofs []BeaconChainProofsBalanceProof) (*types.Transaction, error) {
	return _EigenPodStorage.Contract.VerifyCheckpointProofs(&_EigenPodStorage.TransactOpts, stateRootProof, proofs)
}

// VerifyCheckpointProofs is a paid mutator transaction binding the contract method 0xf074ba62.
//
// Solidity: function verifyCheckpointProofs((bytes32,bytes) stateRootProof, (bytes32,bytes32,bytes)[] proofs) returns()
func (_EigenPodStorage *EigenPodStorageTransactorSession) VerifyCheckpointProofs(stateRootProof BeaconChainProofsStateRootProof, proofs []BeaconChainProofsBalanceProof) (*types.Transaction, error) {
	return _EigenPodStorage.Contract.VerifyCheckpointProofs(&_EigenPodStorage.TransactOpts, stateRootProof, proofs)
}
...
// EigenPodStorageRestakingActivatedIterator is returned from FilterRestakingActivated and is used to iterate over the raw logs and unpacked data for RestakingActivated events raised by the EigenPodStorage contract.
type EigenPodStorageRestakingActivatedIterator struct {
	Event *EigenPodStorageRestakingActivated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *EigenPodStorageRestakingActivatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(EigenPodStorageRestakingActivated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *EigenPodStorageRestakingActivatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *EigenPodStorageRestakingActivatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// EigenPodStorageRestakingActivated represents a RestakingActivated event raised by the EigenPodStorage contract.
type EigenPodStorageRestakingActivated struct {
...
func (_EigenPodStorage *EigenPodStorageFilterer) FilterRestakingActivated(opts *bind.FilterOpts, podOwner []common.Address) (*EigenPodStorageRestakingActivatedIterator, error) {
	...
	logs, sub, err := _EigenPodStorage.contract.FilterLogs(opts, "RestakingActivated", podOwnerRule)
	if err != nil {
		return nil, err
	}
	return &EigenPodStorageRestakingActivatedIterator{contract: _EigenPodStorage.contract, event: "RestakingActivated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event RestakingActivated(address indexed podOwner)
func (_EigenPodStorage *EigenPodStorageFilterer) WatchRestakingActivated(opts *bind.WatchOpts, sink chan<- *EigenPodStorageRestakingActivated, podOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _EigenPodStorage.contract.WatchLogs(opts, "RestakingActivated", podOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(EigenPodStorageRestakingActivated)
				if err := _EigenPodStorage.contract.UnpackLog(event, "RestakingActivated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event RestakingActivated(address indexed podOwner)
func (_EigenPodStorage *EigenPodStorageFilterer) ParseRestakingActivated(log types.Log) (*EigenPodStorageRestakingActivated, error) {
	event := new(EigenPodStorageRestakingActivated)
	if err := _EigenPodStorage.contract.UnpackLog(event, "RestakingActivated", log); err != nil {
		return nil, err
	}
