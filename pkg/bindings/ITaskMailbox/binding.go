...
func (_ITaskMailbox *ITaskMailboxCaller) MAXTASKSLA(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ITaskMailbox.contract.Call(opts, &out, "MAX_TASK_SLA")
...
//
// Solidity: function MAX_TASK_SLA() view returns(uint96)
func (_ITaskMailbox *ITaskMailboxSession) MAXTASKSLA() (*big.Int, error) {
	return _ITaskMailbox.Contract.MAXTASKSLA(&_ITaskMailbox.CallOpts)
}

// MAXTASKSLA is a free data retrieval call binding the contract method 0xd3e043aa.
//
// Solidity: function MAX_TASK_SLA() view returns(uint96)
func (_ITaskMailbox *ITaskMailboxCallerSession) MAXTASKSLA() (*big.Int, error) {
	return _ITaskMailbox.Contract.MAXTASKSLA(&_ITaskMailbox.CallOpts)
}
...
func (_ITaskMailbox *ITaskMailboxCaller) GetMessageHash(opts *bind.CallOpts, taskHash [32]byte, result []byte) ([32]byte, error) {
	var out []interface{}
	err := _ITaskMailbox.contract.Call(opts, &out, "getMessageHash", taskHash, result)
...
//
// Solidity: function getMessageHash(bytes32 taskHash, bytes result) pure returns(bytes32)
func (_ITaskMailbox *ITaskMailboxSession) GetMessageHash(taskHash [32]byte, result []byte) ([32]byte, error) {
	return _ITaskMailbox.Contract.GetMessageHash(&_ITaskMailbox.CallOpts, taskHash, result)
}

// GetMessageHash is a free data retrieval call binding the contract method 0x37eaa104.
//
// Solidity: function getMessageHash(bytes32 taskHash, bytes result) pure returns(bytes32)
func (_ITaskMailbox *ITaskMailboxCallerSession) GetMessageHash(taskHash [32]byte, result []byte) ([32]byte, error) {
	return _ITaskMailbox.Contract.GetMessageHash(&_ITaskMailbox.CallOpts, taskHash, result)
}
