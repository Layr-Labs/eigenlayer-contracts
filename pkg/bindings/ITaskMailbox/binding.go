...
func (_ITaskMailbox *ITaskMailboxCaller) GetFeeSplit(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
	err := _ITaskMailbox.contract.Call(opts, &out, "getFeeSplit")
...
//
// Solidity: function getFeeSplit() view returns(uint16)
func (_ITaskMailbox *ITaskMailboxSession) GetFeeSplit() (uint16, error) {
	return _ITaskMailbox.Contract.GetFeeSplit(&_ITaskMailbox.CallOpts)
}

// GetFeeSplit is a free data retrieval call binding the contract method 0xeda0be69.
//
// Solidity: function getFeeSplit() view returns(uint16)
func (_ITaskMailbox *ITaskMailboxCallerSession) GetFeeSplit() (uint16, error) {
	return _ITaskMailbox.Contract.GetFeeSplit(&_ITaskMailbox.CallOpts)
}
...
func (_ITaskMailbox *ITaskMailboxCaller) GetFeeSplitCollector(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ITaskMailbox.contract.Call(opts, &out, "getFeeSplitCollector")
...
//
// Solidity: function getFeeSplitCollector() view returns(address)
func (_ITaskMailbox *ITaskMailboxSession) GetFeeSplitCollector() (common.Address, error) {
	return _ITaskMailbox.Contract.GetFeeSplitCollector(&_ITaskMailbox.CallOpts)
}

// GetFeeSplitCollector is a free data retrieval call binding the contract method 0x02a74480.
//
// Solidity: function getFeeSplitCollector() view returns(address)
func (_ITaskMailbox *ITaskMailboxCallerSession) GetFeeSplitCollector() (common.Address, error) {
	return _ITaskMailbox.Contract.GetFeeSplitCollector(&_ITaskMailbox.CallOpts)
}
...
func (_ITaskMailbox *ITaskMailboxTransactor) SetFeeSplit(opts *bind.TransactOpts, _feeSplit uint16) (*types.Transaction, error) {
	return _ITaskMailbox.contract.Transact(opts, "setFeeSplit", _feeSplit)
}

// SetFeeSplit is a paid mutator transaction binding the contract method 0x468c07a0.
//
// Solidity: function setFeeSplit(uint16 _feeSplit) returns()
func (_ITaskMailbox *ITaskMailboxSession) SetFeeSplit(_feeSplit uint16) (*types.Transaction, error) {
	return _ITaskMailbox.Contract.SetFeeSplit(&_ITaskMailbox.TransactOpts, _feeSplit)
}

// SetFeeSplit is a paid mutator transaction binding the contract method 0x468c07a0.
//
// Solidity: function setFeeSplit(uint16 _feeSplit) returns()
func (_ITaskMailbox *ITaskMailboxTransactorSession) SetFeeSplit(_feeSplit uint16) (*types.Transaction, error) {
	return _ITaskMailbox.Contract.SetFeeSplit(&_ITaskMailbox.TransactOpts, _feeSplit)
}
...
func (_ITaskMailbox *ITaskMailboxTransactor) SetFeeSplitCollector(opts *bind.TransactOpts, _feeSplitCollector common.Address) (*types.Transaction, error) {
	return _ITaskMailbox.contract.Transact(opts, "setFeeSplitCollector", _feeSplitCollector)
}

// SetFeeSplitCollector is a paid mutator transaction binding the contract method 0x678fbdb3.
//
// Solidity: function setFeeSplitCollector(address _feeSplitCollector) returns()
func (_ITaskMailbox *ITaskMailboxSession) SetFeeSplitCollector(_feeSplitCollector common.Address) (*types.Transaction, error) {
	return _ITaskMailbox.Contract.SetFeeSplitCollector(&_ITaskMailbox.TransactOpts, _feeSplitCollector)
}

// SetFeeSplitCollector is a paid mutator transaction binding the contract method 0x678fbdb3.
//
// Solidity: function setFeeSplitCollector(address _feeSplitCollector) returns()
func (_ITaskMailbox *ITaskMailboxTransactorSession) SetFeeSplitCollector(_feeSplitCollector common.Address) (*types.Transaction, error) {
	return _ITaskMailbox.Contract.SetFeeSplitCollector(&_ITaskMailbox.TransactOpts, _feeSplitCollector)
}
