...
func (_IStakeRootCompendium *IStakeRootCompendiumTransactor) SetMaxTotalCharge(opts *bind.TransactOpts, _maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.contract.Transact(opts, "setMaxTotalCharge", _maxTotalCharge)
}

// SetMaxTotalCharge is a paid mutator transaction binding the contract method 0xf23edeac.
//
// Solidity: function setMaxTotalCharge(uint96 _maxTotalCharge) returns()
func (_IStakeRootCompendium *IStakeRootCompendiumSession) SetMaxTotalCharge(_maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.Contract.SetMaxTotalCharge(&_IStakeRootCompendium.TransactOpts, _maxTotalCharge)
}

// SetMaxTotalCharge is a paid mutator transaction binding the contract method 0xf23edeac.
//
// Solidity: function setMaxTotalCharge(uint96 _maxTotalCharge) returns()
func (_IStakeRootCompendium *IStakeRootCompendiumTransactorSession) SetMaxTotalCharge(_maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.Contract.SetMaxTotalCharge(&_IStakeRootCompendium.TransactOpts, _maxTotalCharge)
}
...
func (_IStakeRootCompendium *IStakeRootCompendiumTransactor) Withdraw(opts *bind.TransactOpts, operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.contract.Transact(opts, "withdraw", operatorSetId, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x0e19dc3a.
//
// Solidity: function withdraw(uint32 operatorSetId, uint256 amount) payable returns(uint256)
func (_IStakeRootCompendium *IStakeRootCompendiumSession) Withdraw(operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.Contract.Withdraw(&_IStakeRootCompendium.TransactOpts, operatorSetId, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x0e19dc3a.
//
// Solidity: function withdraw(uint32 operatorSetId, uint256 amount) payable returns(uint256)
func (_IStakeRootCompendium *IStakeRootCompendiumTransactorSession) Withdraw(operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _IStakeRootCompendium.Contract.Withdraw(&_IStakeRootCompendium.TransactOpts, operatorSetId, amount)
}
