...
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageCaller) GetGlobalTableUpdateSignableDigest(opts *bind.CallOpts, globalTableRoot [32]byte, referenceTimestamp uint32, referenceBlockNumber uint32) ([32]byte, error) {
	var out []interface{}
	err := _OperatorTableUpdaterStorage.contract.Call(opts, &out, "getGlobalTableUpdateSignableDigest", globalTableRoot, referenceTimestamp, referenceBlockNumber)
...
//
// Solidity: function getGlobalTableUpdateSignableDigest(bytes32 globalTableRoot, uint32 referenceTimestamp, uint32 referenceBlockNumber) view returns(bytes32)
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageSession) GetGlobalTableUpdateSignableDigest(globalTableRoot [32]byte, referenceTimestamp uint32, referenceBlockNumber uint32) ([32]byte, error) {
	return _OperatorTableUpdaterStorage.Contract.GetGlobalTableUpdateSignableDigest(&_OperatorTableUpdaterStorage.CallOpts, globalTableRoot, referenceTimestamp, referenceBlockNumber)
}

// GetGlobalTableUpdateSignableDigest is a free data retrieval call binding the contract method 0x401c370f.
//
// Solidity: function getGlobalTableUpdateSignableDigest(bytes32 globalTableRoot, uint32 referenceTimestamp, uint32 referenceBlockNumber) view returns(bytes32)
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageCallerSession) GetGlobalTableUpdateSignableDigest(globalTableRoot [32]byte, referenceTimestamp uint32, referenceBlockNumber uint32) ([32]byte, error) {
	return _OperatorTableUpdaterStorage.Contract.GetGlobalTableUpdateSignableDigest(&_OperatorTableUpdaterStorage.CallOpts, globalTableRoot, referenceTimestamp, referenceBlockNumber)
}
