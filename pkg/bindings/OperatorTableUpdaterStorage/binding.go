...
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageCaller) LatestReferenceTimestamp(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _OperatorTableUpdaterStorage.contract.Call(opts, &out, "latestReferenceTimestamp")
...
//
// Solidity: function latestReferenceTimestamp() view returns(uint32)
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageSession) LatestReferenceTimestamp() (uint32, error) {
	return _OperatorTableUpdaterStorage.Contract.LatestReferenceTimestamp(&_OperatorTableUpdaterStorage.CallOpts)
}

// LatestReferenceTimestamp is a free data retrieval call binding the contract method 0xa6ff5936.
//
// Solidity: function latestReferenceTimestamp() view returns(uint32)
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageCallerSession) LatestReferenceTimestamp() (uint32, error) {
	return _OperatorTableUpdaterStorage.Contract.LatestReferenceTimestamp(&_OperatorTableUpdaterStorage.CallOpts)
}
...
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageTransactor) ConfirmGlobalTableRoot(opts *bind.TransactOpts, globalTableRootCert IBN254CertificateVerifierTypesBN254Certificate, globalTableRoot [32]byte, referenceTimestamp uint32) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.contract.Transact(opts, "confirmGlobalTableRoot", globalTableRootCert, globalTableRoot, referenceTimestamp)
}

// ConfirmGlobalTableRoot is a paid mutator transaction binding the contract method 0x6ab40904.
//
// Solidity: function confirmGlobalTableRoot((uint32,bytes32,(uint256,uint256),(uint256[2],uint256[2]),(uint32,bytes,((uint256,uint256),uint256[]))[]) globalTableRootCert, bytes32 globalTableRoot, uint32 referenceTimestamp) returns()
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageSession) ConfirmGlobalTableRoot(globalTableRootCert IBN254CertificateVerifierTypesBN254Certificate, globalTableRoot [32]byte, referenceTimestamp uint32) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.Contract.ConfirmGlobalTableRoot(&_OperatorTableUpdaterStorage.TransactOpts, globalTableRootCert, globalTableRoot, referenceTimestamp)
}

// ConfirmGlobalTableRoot is a paid mutator transaction binding the contract method 0x6ab40904.
//
// Solidity: function confirmGlobalTableRoot((uint32,bytes32,(uint256,uint256),(uint256[2],uint256[2]),(uint32,bytes,((uint256,uint256),uint256[]))[]) globalTableRootCert, bytes32 globalTableRoot, uint32 referenceTimestamp) returns()
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageTransactorSession) ConfirmGlobalTableRoot(globalTableRootCert IBN254CertificateVerifierTypesBN254Certificate, globalTableRoot [32]byte, referenceTimestamp uint32) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.Contract.ConfirmGlobalTableRoot(&_OperatorTableUpdaterStorage.TransactOpts, globalTableRootCert, globalTableRoot, referenceTimestamp)
}
...
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageTransactor) UpdateOperatorTable(opts *bind.TransactOpts, referenceTimestamp uint32, globalTableRoot [32]byte, operatorSetIndex uint32, proof []byte, tableInfo []byte) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.contract.Transact(opts, "updateOperatorTable", referenceTimestamp, globalTableRoot, operatorSetIndex, proof, tableInfo)
}

// UpdateOperatorTable is a paid mutator transaction binding the contract method 0x9ea94778.
//
// Solidity: function updateOperatorTable(uint32 referenceTimestamp, bytes32 globalTableRoot, uint32 operatorSetIndex, bytes proof, bytes tableInfo) returns()
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageSession) UpdateOperatorTable(referenceTimestamp uint32, globalTableRoot [32]byte, operatorSetIndex uint32, proof []byte, tableInfo []byte) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.Contract.UpdateOperatorTable(&_OperatorTableUpdaterStorage.TransactOpts, referenceTimestamp, globalTableRoot, operatorSetIndex, proof, tableInfo)
}

// UpdateOperatorTable is a paid mutator transaction binding the contract method 0x9ea94778.
//
// Solidity: function updateOperatorTable(uint32 referenceTimestamp, bytes32 globalTableRoot, uint32 operatorSetIndex, bytes proof, bytes tableInfo) returns()
func (_OperatorTableUpdaterStorage *OperatorTableUpdaterStorageTransactorSession) UpdateOperatorTable(referenceTimestamp uint32, globalTableRoot [32]byte, operatorSetIndex uint32, proof []byte, tableInfo []byte) (*types.Transaction, error) {
	return _OperatorTableUpdaterStorage.Contract.UpdateOperatorTable(&_OperatorTableUpdaterStorage.TransactOpts, referenceTimestamp, globalTableRoot, operatorSetIndex, proof, tableInfo)
}
