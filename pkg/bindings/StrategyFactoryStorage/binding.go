...
func (_StrategyFactoryStorage *StrategyFactoryStorageCaller) EIGEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _StrategyFactoryStorage.contract.Call(opts, &out, "EIGEN")
...
//
// Solidity: function EIGEN() view returns(address)
func (_StrategyFactoryStorage *StrategyFactoryStorageSession) EIGEN() (common.Address, error) {
	return _StrategyFactoryStorage.Contract.EIGEN(&_StrategyFactoryStorage.CallOpts)
}

// EIGEN is a free data retrieval call binding the contract method 0xfdc371ce.
//
// Solidity: function EIGEN() view returns(address)
func (_StrategyFactoryStorage *StrategyFactoryStorageCallerSession) EIGEN() (common.Address, error) {
	return _StrategyFactoryStorage.Contract.EIGEN(&_StrategyFactoryStorage.CallOpts)
}
...
func (_StrategyFactoryStorage *StrategyFactoryStorageCaller) BEIGEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _StrategyFactoryStorage.contract.Call(opts, &out, "bEIGEN")
...
//
// Solidity: function bEIGEN() view returns(address)
func (_StrategyFactoryStorage *StrategyFactoryStorageSession) BEIGEN() (common.Address, error) {
	return _StrategyFactoryStorage.Contract.BEIGEN(&_StrategyFactoryStorage.CallOpts)
}

// BEIGEN is a free data retrieval call binding the contract method 0x3f4da4c6.
//
// Solidity: function bEIGEN() view returns(address)
func (_StrategyFactoryStorage *StrategyFactoryStorageCallerSession) BEIGEN() (common.Address, error) {
	return _StrategyFactoryStorage.Contract.BEIGEN(&_StrategyFactoryStorage.CallOpts)
}
