...
// DeprecatedWithdrawalRootPending is a free data retrieval call binding the contract method 0x3cbdf859.
//
// Solidity: function __deprecated_withdrawalRootPending(bytes32 ) view returns(bool)
func (_StrategyManagerStorage *StrategyManagerStorageCaller) DeprecatedWithdrawalRootPending(opts *bind.CallOpts, arg0 [32]byte) (bool, error) {
	var out []interface{}
	err := _StrategyManagerStorage.contract.Call(opts, &out, "__deprecated_withdrawalRootPending", arg0)
...
//
// Solidity: function __deprecated_withdrawalRootPending(bytes32 ) view returns(bool)
func (_StrategyManagerStorage *StrategyManagerStorageSession) DeprecatedWithdrawalRootPending(arg0 [32]byte) (bool, error) {
	return _StrategyManagerStorage.Contract.DeprecatedWithdrawalRootPending(&_StrategyManagerStorage.CallOpts, arg0)
}

// DeprecatedWithdrawalRootPending is a free data retrieval call binding the contract method 0x3cbdf859.
//
// Solidity: function __deprecated_withdrawalRootPending(bytes32 ) view returns(bool)
func (_StrategyManagerStorage *StrategyManagerStorageCallerSession) DeprecatedWithdrawalRootPending(arg0 [32]byte) (bool, error) {
	return _StrategyManagerStorage.Contract.DeprecatedWithdrawalRootPending(&_StrategyManagerStorage.CallOpts, arg0)
}
