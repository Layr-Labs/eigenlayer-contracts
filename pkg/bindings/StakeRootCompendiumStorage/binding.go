...
// MINPROOFSDURATION is a free data retrieval call binding the contract method 0x47917445.
//
// Solidity: function MIN_PROOFS_DURATION() view returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCaller) MINPROOFSDURATION(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakeRootCompendiumStorage.contract.Call(opts, &out, "MIN_PROOFS_DURATION")
...
//
// Solidity: function MIN_PROOFS_DURATION() view returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) MINPROOFSDURATION() (*big.Int, error) {
	return _StakeRootCompendiumStorage.Contract.MINPROOFSDURATION(&_StakeRootCompendiumStorage.CallOpts)
}

// MINPROOFSDURATION is a free data retrieval call binding the contract method 0x47917445.
//
// Solidity: function MIN_PROOFS_DURATION() view returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCallerSession) MINPROOFSDURATION() (*big.Int, error) {
	return _StakeRootCompendiumStorage.Contract.MINPROOFSDURATION(&_StakeRootCompendiumStorage.CallOpts)
}
...
//
// Solidity: function depositInfos(address , uint32 ) view returns(uint96 balance, uint32 lastUpdatedTimestamp, uint96 totalChargePerOperatorSetLastPaid, uint96 totalChargePerStrategyLastPaid)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCaller) DepositInfos(opts *bind.CallOpts, arg0 common.Address, arg1 uint32) (struct {
	...
	outstruct.LastUpdatedTimestamp = *abi.ConvertType(out[1], new(uint32)).(*uint32)
