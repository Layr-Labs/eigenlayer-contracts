...
//
// Solidity: function depositInfos(address , uint32 ) view returns(uint96 balance, uint32 lastDemandIncreaseTimestamp, uint32 lastUpdatedTimestamp, uint96 totalChargePerOperatorSetLastPaid, uint96 totalChargePerStrategyLastPaid)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCaller) DepositInfos(opts *bind.CallOpts, arg0 common.Address, arg1 uint32) (struct {
	...
	outstruct.LastUpdatedTimestamp = *abi.ConvertType(out[2], new(uint32)).(*uint32)
	outstruct.TotalChargePerOperatorSetLastPaid = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.TotalChargePerStrategyLastPaid = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
