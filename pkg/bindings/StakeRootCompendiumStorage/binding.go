...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCaller) MINPREPAIDPROOFS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakeRootCompendiumStorage.contract.Call(opts, &out, "MIN_PREPAID_PROOFS")
...
//
// Solidity: function MIN_PREPAID_PROOFS() view returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) MINPREPAIDPROOFS() (*big.Int, error) {
	return _StakeRootCompendiumStorage.Contract.MINPREPAIDPROOFS(&_StakeRootCompendiumStorage.CallOpts)
}

// MINPREPAIDPROOFS is a free data retrieval call binding the contract method 0x04871242.
//
// Solidity: function MIN_PREPAID_PROOFS() view returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageCallerSession) MINPREPAIDPROOFS() (*big.Int, error) {
	return _StakeRootCompendiumStorage.Contract.MINPREPAIDPROOFS(&_StakeRootCompendiumStorage.CallOpts)
}
...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactor) SetChargePerProof(opts *bind.TransactOpts, _chargePerStrategy *big.Int, _chargePerOperatorSet *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.contract.Transact(opts, "setChargePerProof", _chargePerStrategy, _chargePerOperatorSet)
}

// SetChargePerProof is a paid mutator transaction binding the contract method 0x1016d85b.
//
// Solidity: function setChargePerProof(uint96 _chargePerStrategy, uint96 _chargePerOperatorSet) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) SetChargePerProof(_chargePerStrategy *big.Int, _chargePerOperatorSet *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetChargePerProof(&_StakeRootCompendiumStorage.TransactOpts, _chargePerStrategy, _chargePerOperatorSet)
}

// SetChargePerProof is a paid mutator transaction binding the contract method 0x1016d85b.
//
// Solidity: function setChargePerProof(uint96 _chargePerStrategy, uint96 _chargePerOperatorSet) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactorSession) SetChargePerProof(_chargePerStrategy *big.Int, _chargePerOperatorSet *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetChargePerProof(&_StakeRootCompendiumStorage.TransactOpts, _chargePerStrategy, _chargePerOperatorSet)
}
...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactor) SetMaxTotalCharge(opts *bind.TransactOpts, _maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.contract.Transact(opts, "setMaxTotalCharge", _maxTotalCharge)
}

// SetMaxTotalCharge is a paid mutator transaction binding the contract method 0xf23edeac.
//
// Solidity: function setMaxTotalCharge(uint96 _maxTotalCharge) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) SetMaxTotalCharge(_maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetMaxTotalCharge(&_StakeRootCompendiumStorage.TransactOpts, _maxTotalCharge)
}

// SetMaxTotalCharge is a paid mutator transaction binding the contract method 0xf23edeac.
//
// Solidity: function setMaxTotalCharge(uint96 _maxTotalCharge) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactorSession) SetMaxTotalCharge(_maxTotalCharge *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetMaxTotalCharge(&_StakeRootCompendiumStorage.TransactOpts, _maxTotalCharge)
}
...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactor) SetProofIntervalSeconds(opts *bind.TransactOpts, proofIntervalSeconds uint32) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.contract.Transact(opts, "setProofIntervalSeconds", proofIntervalSeconds)
}

// SetProofIntervalSeconds is a paid mutator transaction binding the contract method 0xafc6c70b.
//
// Solidity: function setProofIntervalSeconds(uint32 proofIntervalSeconds) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) SetProofIntervalSeconds(proofIntervalSeconds uint32) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetProofIntervalSeconds(&_StakeRootCompendiumStorage.TransactOpts, proofIntervalSeconds)
}

// SetProofIntervalSeconds is a paid mutator transaction binding the contract method 0xafc6c70b.
//
// Solidity: function setProofIntervalSeconds(uint32 proofIntervalSeconds) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactorSession) SetProofIntervalSeconds(proofIntervalSeconds uint32) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetProofIntervalSeconds(&_StakeRootCompendiumStorage.TransactOpts, proofIntervalSeconds)
}
...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactor) SetRootConfirmer(opts *bind.TransactOpts, _rootConfirmer common.Address) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.contract.Transact(opts, "setRootConfirmer", _rootConfirmer)
}

// SetRootConfirmer is a paid mutator transaction binding the contract method 0x758e3bfb.
//
// Solidity: function setRootConfirmer(address _rootConfirmer) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) SetRootConfirmer(_rootConfirmer common.Address) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetRootConfirmer(&_StakeRootCompendiumStorage.TransactOpts, _rootConfirmer)
}

// SetRootConfirmer is a paid mutator transaction binding the contract method 0x758e3bfb.
//
// Solidity: function setRootConfirmer(address _rootConfirmer) returns()
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactorSession) SetRootConfirmer(_rootConfirmer common.Address) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.SetRootConfirmer(&_StakeRootCompendiumStorage.TransactOpts, _rootConfirmer)
}
...
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactor) Withdraw(opts *bind.TransactOpts, operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.contract.Transact(opts, "withdraw", operatorSetId, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x0e19dc3a.
//
// Solidity: function withdraw(uint32 operatorSetId, uint256 amount) payable returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageSession) Withdraw(operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.Withdraw(&_StakeRootCompendiumStorage.TransactOpts, operatorSetId, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x0e19dc3a.
//
// Solidity: function withdraw(uint32 operatorSetId, uint256 amount) payable returns(uint256)
func (_StakeRootCompendiumStorage *StakeRootCompendiumStorageTransactorSession) Withdraw(operatorSetId uint32, amount *big.Int) (*types.Transaction, error) {
	return _StakeRootCompendiumStorage.Contract.Withdraw(&_StakeRootCompendiumStorage.TransactOpts, operatorSetId, amount)
}
