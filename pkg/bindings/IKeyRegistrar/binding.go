...
func (_IKeyRegistrar *IKeyRegistrarCaller) CheckKey(opts *bind.CallOpts, operatorSet OperatorSet, operator common.Address) (bool, error) {
	var out []interface{}
	err := _IKeyRegistrar.contract.Call(opts, &out, "checkKey", operatorSet, operator)
...
//
// Solidity: function checkKey((address,uint32) operatorSet, address operator) view returns(bool)
func (_IKeyRegistrar *IKeyRegistrarSession) CheckKey(operatorSet OperatorSet, operator common.Address) (bool, error) {
	return _IKeyRegistrar.Contract.CheckKey(&_IKeyRegistrar.CallOpts, operatorSet, operator)
}

// CheckKey is a free data retrieval call binding the contract method 0x0a6ac264.
//
// Solidity: function checkKey((address,uint32) operatorSet, address operator) view returns(bool)
func (_IKeyRegistrar *IKeyRegistrarCallerSession) CheckKey(operatorSet OperatorSet, operator common.Address) (bool, error) {
	return _IKeyRegistrar.Contract.CheckKey(&_IKeyRegistrar.CallOpts, operatorSet, operator)
}
