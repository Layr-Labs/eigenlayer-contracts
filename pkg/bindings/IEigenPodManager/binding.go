...
//
// Solidity: function nonNormalizedPodOwnerShares(address podOwner) view returns(int256)
func (_IEigenPodManager *IEigenPodManagerCaller) NonNormalizedPodOwnerShares(opts *bind.CallOpts, podOwner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _IEigenPodManager.contract.Call(opts, &out, "nonNormalizedPodOwnerShares", podOwner)
...
//
// Solidity: function nonNormalizedPodOwnerShares(address podOwner) view returns(int256)
func (_IEigenPodManager *IEigenPodManagerSession) NonNormalizedPodOwnerShares(podOwner common.Address) (*big.Int, error) {
	return _IEigenPodManager.Contract.NonNormalizedPodOwnerShares(&_IEigenPodManager.CallOpts, podOwner)
}

// NonNormalizedPodOwnerShares is a free data retrieval call binding the contract method 0x5020bae8.
//
// Solidity: function nonNormalizedPodOwnerShares(address podOwner) view returns(int256)
func (_IEigenPodManager *IEigenPodManagerCallerSession) NonNormalizedPodOwnerShares(podOwner common.Address) (*big.Int, error) {
	return _IEigenPodManager.Contract.NonNormalizedPodOwnerShares(&_IEigenPodManager.CallOpts, podOwner)
}
