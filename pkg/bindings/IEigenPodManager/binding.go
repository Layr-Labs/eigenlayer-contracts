...
func (_IEigenPodManager *IEigenPodManagerFilterer) FilterPodSharesUpdated(opts *bind.FilterOpts, podOwner []common.Address, pod []common.Address) (*IEigenPodManagerPodSharesUpdatedIterator, error) {
	...
	logs, sub, err := _IEigenPodManager.contract.FilterLogs(opts, "PodSharesUpdated", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event PodSharesUpdated(address indexed podOwner, address indexed pod, int256 newTotalShares, int256 sharesDelta)
func (_IEigenPodManager *IEigenPodManagerFilterer) WatchPodSharesUpdated(opts *bind.WatchOpts, sink chan<- *IEigenPodManagerPodSharesUpdated, podOwner []common.Address, pod []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IEigenPodManager.contract.WatchLogs(opts, "PodSharesUpdated", podOwnerRule, podRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
