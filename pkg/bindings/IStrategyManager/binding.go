...
func (_IStrategyManager *IStrategyManagerCaller) GetNonNormalizedDeposits(opts *bind.CallOpts, staker common.Address) ([]common.Address, []*big.Int, error) {
	var out []interface{}
	err := _IStrategyManager.contract.Call(opts, &out, "getNonNormalizedDeposits", staker)
...
//
// Solidity: function getNonNormalizedDeposits(address staker) view returns(address[], uint256[])
func (_IStrategyManager *IStrategyManagerSession) GetNonNormalizedDeposits(staker common.Address) ([]common.Address, []*big.Int, error) {
	return _IStrategyManager.Contract.GetNonNormalizedDeposits(&_IStrategyManager.CallOpts, staker)
}

// GetNonNormalizedDeposits is a free data retrieval call binding the contract method 0x2d764ffb.
//
// Solidity: function getNonNormalizedDeposits(address staker) view returns(address[], uint256[])
func (_IStrategyManager *IStrategyManagerCallerSession) GetNonNormalizedDeposits(staker common.Address) ([]common.Address, []*big.Int, error) {
	return _IStrategyManager.Contract.GetNonNormalizedDeposits(&_IStrategyManager.CallOpts, staker)
}

// NonNormalizedStakerStrategyShares is a free data retrieval call binding the contract method 0x2f74c7f6.
//
// Solidity: function nonNormalizedStakerStrategyShares(address user, address strategy) view returns(uint256)
func (_IStrategyManager *IStrategyManagerCaller) NonNormalizedStakerStrategyShares(opts *bind.CallOpts, user common.Address, strategy common.Address) (*big.Int, error) {
	var out []interface{}
	err := _IStrategyManager.contract.Call(opts, &out, "nonNormalizedStakerStrategyShares", user, strategy)
...
//
// Solidity: function nonNormalizedStakerStrategyShares(address user, address strategy) view returns(uint256)
func (_IStrategyManager *IStrategyManagerSession) NonNormalizedStakerStrategyShares(user common.Address, strategy common.Address) (*big.Int, error) {
	return _IStrategyManager.Contract.NonNormalizedStakerStrategyShares(&_IStrategyManager.CallOpts, user, strategy)
}

// NonNormalizedStakerStrategyShares is a free data retrieval call binding the contract method 0x2f74c7f6.
//
// Solidity: function nonNormalizedStakerStrategyShares(address user, address strategy) view returns(uint256)
func (_IStrategyManager *IStrategyManagerCallerSession) NonNormalizedStakerStrategyShares(user common.Address, strategy common.Address) (*big.Int, error) {
	return _IStrategyManager.Contract.NonNormalizedStakerStrategyShares(&_IStrategyManager.CallOpts, user, strategy)
}
