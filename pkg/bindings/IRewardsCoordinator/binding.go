...
// IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator is returned from FilterRewardsForAllStakersAndOperatorsCreated and is used to iterate over the raw logs and unpacked data for RewardsForAllStakersAndOperatorsCreated events raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator struct {
	Event *IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated represents a RewardsForAllStakersAndOperatorsCreated event raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated struct {
...
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) FilterRewardsForAllStakersAndOperatorsCreated(opts *bind.FilterOpts, tokenHopper []common.Address, submissionNonce []*big.Int, rewardsSubmissionHash [][32]byte) (*IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.FilterLogs(opts, "RewardsForAllStakersAndOperatorsCreated", tokenHopperRule, submissionNonceRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return &IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreatedIterator{contract: _IRewardsCoordinator.contract, event: "RewardsForAllStakersAndOperatorsCreated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event RewardsForAllStakersAndOperatorsCreated(address indexed tokenHopper, uint256 indexed submissionNonce, bytes32 indexed rewardsSubmissionHash, ((address,uint96)[],address,uint256,uint32,uint32) rewardsSubmission)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) WatchRewardsForAllStakersAndOperatorsCreated(opts *bind.WatchOpts, sink chan<- *IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated, tokenHopper []common.Address, submissionNonce []*big.Int, rewardsSubmissionHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.WatchLogs(opts, "RewardsForAllStakersAndOperatorsCreated", tokenHopperRule, submissionNonceRule, rewardsSubmissionHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated)
				if err := _IRewardsCoordinator.contract.UnpackLog(event, "RewardsForAllStakersAndOperatorsCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event RewardsForAllStakersAndOperatorsCreated(address indexed tokenHopper, uint256 indexed submissionNonce, bytes32 indexed rewardsSubmissionHash, ((address,uint96)[],address,uint256,uint32,uint32) rewardsSubmission)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) ParseRewardsForAllStakersAndOperatorsCreated(log types.Log) (*IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated, error) {
	event := new(IRewardsCoordinatorRewardsForAllStakersAndOperatorsCreated)
	if err := _IRewardsCoordinator.contract.UnpackLog(event, "RewardsForAllStakersAndOperatorsCreated", log); err != nil {
		return nil, err
	}
...
// IRewardsCoordinatorTokenHopperSetIterator is returned from FilterTokenHopperSet and is used to iterate over the raw logs and unpacked data for TokenHopperSet events raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorTokenHopperSetIterator struct {
	Event *IRewardsCoordinatorTokenHopperSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IRewardsCoordinatorTokenHopperSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IRewardsCoordinatorTokenHopperSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IRewardsCoordinatorTokenHopperSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IRewardsCoordinatorTokenHopperSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IRewardsCoordinatorTokenHopperSet represents a TokenHopperSet event raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorTokenHopperSet struct {
...
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) FilterTokenHopperSet(opts *bind.FilterOpts, oldTokenHopper []common.Address, newTokenHopper []common.Address) (*IRewardsCoordinatorTokenHopperSetIterator, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.FilterLogs(opts, "TokenHopperSet", oldTokenHopperRule, newTokenHopperRule)
	if err != nil {
		return nil, err
	}
	return &IRewardsCoordinatorTokenHopperSetIterator{contract: _IRewardsCoordinator.contract, event: "TokenHopperSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokenHopperSet(address indexed oldTokenHopper, address indexed newTokenHopper)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) WatchTokenHopperSet(opts *bind.WatchOpts, sink chan<- *IRewardsCoordinatorTokenHopperSet, oldTokenHopper []common.Address, newTokenHopper []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.WatchLogs(opts, "TokenHopperSet", oldTokenHopperRule, newTokenHopperRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IRewardsCoordinatorTokenHopperSet)
				if err := _IRewardsCoordinator.contract.UnpackLog(event, "TokenHopperSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TokenHopperSet(address indexed oldTokenHopper, address indexed newTokenHopper)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) ParseTokenHopperSet(log types.Log) (*IRewardsCoordinatorTokenHopperSet, error) {
	event := new(IRewardsCoordinatorTokenHopperSet)
	if err := _IRewardsCoordinator.contract.UnpackLog(event, "TokenHopperSet", log); err != nil {
		return nil, err
	}
