...
func (_IRewardsCoordinator *IRewardsCoordinatorTransactor) CreateDirectAVSRewardSubmission(opts *bind.TransactOpts, earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _IRewardsCoordinator.contract.Transact(opts, "createDirectAVSRewardSubmission", earners, amounts, token)
}

// CreateDirectAVSRewardSubmission is a paid mutator transaction binding the contract method 0x0a6563e3.
//
// Solidity: function createDirectAVSRewardSubmission(address[] earners, uint256[] amounts, address token) returns()
func (_IRewardsCoordinator *IRewardsCoordinatorSession) CreateDirectAVSRewardSubmission(earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _IRewardsCoordinator.Contract.CreateDirectAVSRewardSubmission(&_IRewardsCoordinator.TransactOpts, earners, amounts, token)
}

// CreateDirectAVSRewardSubmission is a paid mutator transaction binding the contract method 0x0a6563e3.
//
// Solidity: function createDirectAVSRewardSubmission(address[] earners, uint256[] amounts, address token) returns()
func (_IRewardsCoordinator *IRewardsCoordinatorTransactorSession) CreateDirectAVSRewardSubmission(earners []common.Address, amounts []*big.Int, token common.Address) (*types.Transaction, error) {
	return _IRewardsCoordinator.Contract.CreateDirectAVSRewardSubmission(&_IRewardsCoordinator.TransactOpts, earners, amounts, token)
}
...
// IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator is returned from FilterDirectAVSRewardSubmissionCreated and is used to iterate over the raw logs and unpacked data for DirectAVSRewardSubmissionCreated events raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator struct {
	Event *IRewardsCoordinatorDirectAVSRewardSubmissionCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IRewardsCoordinatorDirectAVSRewardSubmissionCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IRewardsCoordinatorDirectAVSRewardSubmissionCreated represents a DirectAVSRewardSubmissionCreated event raised by the IRewardsCoordinator contract.
type IRewardsCoordinatorDirectAVSRewardSubmissionCreated struct {
	Avs    common.Address
	Earner common.Address
	Token  common.Address
	Amount *big.Int
...
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) FilterDirectAVSRewardSubmissionCreated(opts *bind.FilterOpts, avs []common.Address, earner []common.Address) (*IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.FilterLogs(opts, "DirectAVSRewardSubmissionCreated", avsRule, earnerRule)
	if err != nil {
		return nil, err
	}
	return &IRewardsCoordinatorDirectAVSRewardSubmissionCreatedIterator{contract: _IRewardsCoordinator.contract, event: "DirectAVSRewardSubmissionCreated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DirectAVSRewardSubmissionCreated(address indexed avs, address indexed earner, address token, uint256 amount)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) WatchDirectAVSRewardSubmissionCreated(opts *bind.WatchOpts, sink chan<- *IRewardsCoordinatorDirectAVSRewardSubmissionCreated, avs []common.Address, earner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IRewardsCoordinator.contract.WatchLogs(opts, "DirectAVSRewardSubmissionCreated", avsRule, earnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IRewardsCoordinatorDirectAVSRewardSubmissionCreated)
				if err := _IRewardsCoordinator.contract.UnpackLog(event, "DirectAVSRewardSubmissionCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DirectAVSRewardSubmissionCreated(address indexed avs, address indexed earner, address token, uint256 amount)
func (_IRewardsCoordinator *IRewardsCoordinatorFilterer) ParseDirectAVSRewardSubmissionCreated(log types.Log) (*IRewardsCoordinatorDirectAVSRewardSubmissionCreated, error) {
	event := new(IRewardsCoordinatorDirectAVSRewardSubmissionCreated)
	if err := _IRewardsCoordinator.contract.UnpackLog(event, "DirectAVSRewardSubmissionCreated", log); err != nil {
		return nil, err
	}
