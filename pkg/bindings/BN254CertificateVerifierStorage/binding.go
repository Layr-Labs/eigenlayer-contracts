...
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCaller) CalculateCertificateDigest(opts *bind.CallOpts, referenceTimestamp uint32, messageHash [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _BN254CertificateVerifierStorage.contract.Call(opts, &out, "calculateCertificateDigest", referenceTimestamp, messageHash)
...
//
// Solidity: function calculateCertificateDigest(uint32 referenceTimestamp, bytes32 messageHash) pure returns(bytes32)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) CalculateCertificateDigest(referenceTimestamp uint32, messageHash [32]byte) ([32]byte, error) {
	return _BN254CertificateVerifierStorage.Contract.CalculateCertificateDigest(&_BN254CertificateVerifierStorage.CallOpts, referenceTimestamp, messageHash)
}

// CalculateCertificateDigest is a free data retrieval call binding the contract method 0x18467434.
//
// Solidity: function calculateCertificateDigest(uint32 referenceTimestamp, bytes32 messageHash) pure returns(bytes32)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) CalculateCertificateDigest(referenceTimestamp uint32, messageHash [32]byte) ([32]byte, error) {
	return _BN254CertificateVerifierStorage.Contract.CalculateCertificateDigest(&_BN254CertificateVerifierStorage.CallOpts, referenceTimestamp, messageHash)
}
...
//
// Solidity: function getNonsignerOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint256 operatorIndex) view returns(((uint256,uint256),uint256[]))
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) GetNonsignerOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex *big.Int) (IOperatorTableCalculatorTypesBN254OperatorInfo, error) {
...
//
// Solidity: function getNonsignerOperatorInfo((address,uint32) operatorSet, uint32 referenceTimestamp, uint256 operatorIndex) view returns(((uint256,uint256),uint256[]))
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) GetNonsignerOperatorInfo(operatorSet OperatorSet, referenceTimestamp uint32, operatorIndex *big.Int) (IOperatorTableCalculatorTypesBN254OperatorInfo, error) {
	return _BN254CertificateVerifierStorage.Contract.GetNonsignerOperatorInfo(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp, operatorIndex)
}
...
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCaller) GetOperatorCount(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32) (*big.Int, error) {
	var out []interface{}
	err := _BN254CertificateVerifierStorage.contract.Call(opts, &out, "getOperatorCount", operatorSet, referenceTimestamp)
...
//
// Solidity: function getOperatorCount((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(uint256)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) GetOperatorCount(operatorSet OperatorSet, referenceTimestamp uint32) (*big.Int, error) {
	return _BN254CertificateVerifierStorage.Contract.GetOperatorCount(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}

// GetOperatorCount is a free data retrieval call binding the contract method 0x23c2a3cb.
//
// Solidity: function getOperatorCount((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(uint256)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) GetOperatorCount(operatorSet OperatorSet, referenceTimestamp uint32) (*big.Int, error) {
	return _BN254CertificateVerifierStorage.Contract.GetOperatorCount(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}
...
//
// Solidity: function getOperatorSetInfo((address,uint32) operatorSet, uint32 referenceTimestamp) view returns((bytes32,uint256,(uint256,uint256),uint256[]))
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) GetOperatorSetInfo(operatorSet OperatorSet, referenceTimestamp uint32) (IOperatorTableCalculatorTypesBN254OperatorSetInfo, error) {
...
//
// Solidity: function getOperatorSetInfo((address,uint32) operatorSet, uint32 referenceTimestamp) view returns((bytes32,uint256,(uint256,uint256),uint256[]))
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) GetOperatorSetInfo(operatorSet OperatorSet, referenceTimestamp uint32) (IOperatorTableCalculatorTypesBN254OperatorSetInfo, error) {
	return _BN254CertificateVerifierStorage.Contract.GetOperatorSetInfo(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}
...
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCaller) GetTotalStakeWeights(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32) ([]*big.Int, error) {
	var out []interface{}
	err := _BN254CertificateVerifierStorage.contract.Call(opts, &out, "getTotalStakeWeights", operatorSet, referenceTimestamp)
...
//
// Solidity: function getTotalStakeWeights((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(uint256[])
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) GetTotalStakeWeights(operatorSet OperatorSet, referenceTimestamp uint32) ([]*big.Int, error) {
	return _BN254CertificateVerifierStorage.Contract.GetTotalStakeWeights(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}

// GetTotalStakeWeights is a free data retrieval call binding the contract method 0x7d1d1f5b.
//
// Solidity: function getTotalStakeWeights((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(uint256[])
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) GetTotalStakeWeights(operatorSet OperatorSet, referenceTimestamp uint32) ([]*big.Int, error) {
	return _BN254CertificateVerifierStorage.Contract.GetTotalStakeWeights(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}
...
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCaller) IsReferenceTimestampSet(opts *bind.CallOpts, operatorSet OperatorSet, referenceTimestamp uint32) (bool, error) {
	var out []interface{}
	err := _BN254CertificateVerifierStorage.contract.Call(opts, &out, "isReferenceTimestampSet", operatorSet, referenceTimestamp)
...
//
// Solidity: function isReferenceTimestampSet((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(bool)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) IsReferenceTimestampSet(operatorSet OperatorSet, referenceTimestamp uint32) (bool, error) {
	return _BN254CertificateVerifierStorage.Contract.IsReferenceTimestampSet(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}

// IsReferenceTimestampSet is a free data retrieval call binding the contract method 0xcd83a72b.
//
// Solidity: function isReferenceTimestampSet((address,uint32) operatorSet, uint32 referenceTimestamp) view returns(bool)
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageCallerSession) IsReferenceTimestampSet(operatorSet OperatorSet, referenceTimestamp uint32) (bool, error) {
	return _BN254CertificateVerifierStorage.Contract.IsReferenceTimestampSet(&_BN254CertificateVerifierStorage.CallOpts, operatorSet, referenceTimestamp)
}
...
//
// Solidity: function updateOperatorTable((address,uint32) operatorSet, uint32 referenceTimestamp, (bytes32,uint256,(uint256,uint256),uint256[]) operatorSetInfo, (address,uint32) operatorSetConfig) returns()
func (_BN254CertificateVerifierStorage *BN254CertificateVerifierStorageSession) UpdateOperatorTable(operatorSet OperatorSet, referenceTimestamp uint32, operatorSetInfo IOperatorTableCalculatorTypesBN254OperatorSetInfo, operatorSetConfig ICrossChainRegistryTypesOperatorSetConfig) (*types.Transaction, error) {
