...
contract KeyRegistrarUnitTests is Test {
    ...
    uint256 public ecdsaPrivKey1 = 0x1234567890123456789012345678901234567890123456789012345678901234;
    uint256 public ecdsaPrivKey2 = 0x9876543210987654321098765432109876543210987654321098765432109876;
    ...
    function _generateECDSASignature(
        ...
        bytes32 messageHash = keccak256(abi.encodePacked(
            "EigenLayer.KeyRegistrar.ECDSA.v1",
    ...
    function testRegisterECDSAKey() public {
        ...
        bytes memory signature = _generateECDSASignature(
            operator1,
            operatorSet,
            ecdsaAddress1,
            ecdsaPrivKey1
    ...
    function testRegisterECDSAKey_RevertInvalidFormat() public {
        ...
        bytes memory invalidKey2 = hex"b5bb9d8014a0f9b1d61e21e796d78dccdf1352f23cd32812f4850b878ae4944c86a57d8a35ebfd17be4b8d44d0f7b8d5b5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5e5";
    ...
    function testRegisterECDSAKey_RevertGloballyRegistered() public {
        ...
        bytes memory signature1 = _generateECDSASignature(
            operator1,
            operatorSet1,
            ecdsaAddress1,
            ecdsaPrivKey1
        ...
        bytes memory signature2 = _generateECDSASignature(
            operator2,
            operatorSet2,
            ecdsaAddress1,
            ecdsaPrivKey1
    ...
    function testMultipleOperatorSets_DifferentKeyTypes() public {
        ...
        bytes memory ecdsaSignature = _generateECDSASignature(
            operator1,
            ecdsaOperatorSet,
            ecdsaAddress1,
            ecdsaPrivKey1
        ...
        bytes memory bn254Signature = _generateBN254Signature(
            operator1, 
            bn254OperatorSet, 
            bn254Key1, 
            bn254PrivKey1
