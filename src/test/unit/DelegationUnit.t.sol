...
contract DelegationManagerUnitTests is EigenLayerUnitTestSetup, IDelegationManagerEvents {
    ...
    function _setUpQueueWithdrawalsSingleStrat(
        ...
        scaledSharesToWithdrawArray[0] = scaledSharesToWithdraw;
        ...
        queuedWithdrawalParams[0] = IDelegationManagerTypes.QueuedWithdrawalParams({
            ...
            shares: scaledSharesToWithdrawArray,
    ...
    function _setUpQueueWithdrawals(
        ...
        IDelegationManagerTypes.Withdrawal memory withdrawal = IDelegationManagerTypes.Withdrawal({
            ...
            startTimestamp: uint32(block.timestamp),
            strategies: strategies,
            scaledSharesToWithdraw: withdrawalAmounts
        });
        bytes32 withdrawalRoot = delegationManager.calculateWithdrawalRoot(withdrawal);
    ...
    function _setUpCompleteQueuedWithdrawalSingleStrat(
        ...
        (
            ...
            scaledSharesToWithdraw: withdrawalAmount
        });
...
contract DelegationManagerUnitTests_Undelegate is DelegationManagerUnitTests {
     ...
     * TODO: fuzz magnitude
     */
    function testFuzz_undelegate_slashedOperator(uint128 shares) public {
        ...
        assertTrue(ssf.depositScalingFactor > WAD, "bad test setup");
        ...
        uint256 scaledSharesToWithdraw = SlashingLib.scaleSharesForQueuedWithdrawal(withdrawableSharesBefore, ssf, operatorMagnitude);
    ...
    function testFuzz_undelegate_slashedWhileStaked(uint128 shares) public {
        ...
        assertEq(ssf.depositScalingFactor, WAD, "bad test setup");
...
contract DelegationManagerUnitTests_completeQueuedWithdrawal is DelegationManagerUnitTests {
    ...
    function test_Revert_WhenTokensArrayLengthMismatch() public {
        _registerOperatorWithBaseDetails(defaultOperator);
        (IDelegationManagerTypes.Withdrawal memory withdrawal, , ) = _setUpCompleteQueuedWithdrawalSingleStrat({
            staker: defaultStaker,
            withdrawer: defaultStaker,
            depositAmount: 100,
            withdrawalAmount: 100
