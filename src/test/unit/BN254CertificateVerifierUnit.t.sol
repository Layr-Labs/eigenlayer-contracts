...
contract BN254CertificateVerifierTest is Test {
    ...
    event TableUpdated(
        ...
        IBN254TableCalculatorTypes.BN254OperatorSetInfo operatorSetInfo
    );
    ...
    function createOperatorsWithSplitKeys(uint256 pseudoRandomNumber, uint256 numSigners, uint256 numNonSigners) 
        internal view returns (
            IBN254TableCalculatorTypes.BN254OperatorInfo[] memory,
            uint32[] memory,
        ...
        ) 
    {
        ...
        for (uint32 i = 0; i < numSigners; i++) {
            ...
            ops[i].weights = new uint256[](2);
            ops[i].weights[0] = uint256(100 + i * 10);
            ops[i].weights[1] = uint256(200 + i * 20);
        }
        ...
        for (uint32 i = 0; i < numNonSigners; i++) {
            ...
            ops[idx].weights = new uint256[](2);
            ops[idx].weights[0] = uint256(100 + idx * 10);
            ops[idx].weights[1] = uint256(200 + idx * 20);
    ...
    function getMerkleRoot(IBN254TableCalculatorTypes.BN254OperatorInfo[] memory ops) 
    ...
    function createOperatorSetInfo(IBN254TableCalculatorTypes.BN254OperatorInfo[] memory ops) 
        internal returns (IBN254TableCalculatorTypes.BN254OperatorSetInfo memory) {
        ...
        uint256[] memory _totalWeights = new uint256[](2);
    ...
    function createOperatorSetConfig() internal view returns (ICrossChainRegistryTypes.OperatorSetConfig memory) {
        return ICrossChainRegistryTypes.OperatorSetConfig({
            owner: operatorSetOwner,
            maxStalenessPeriod: maxStaleness
        });
    }
    ...
    function testUpdateOperatorTable() public {
        ...
        (IBN254TableCalculatorTypes.BN254OperatorInfo[] memory operators, , ) = 
    ...
    function testVerifyCertificate() public {
        ...
        uint256[] memory expectedSignedStakes = new uint256[](2);
    ...
    function testVerifyCertificateProportion() public {
        ...
        uint256[] memory signedStakes = verifier.verifyCertificate(testOperatorSet, cert);
        uint256 signedPercentage0 = (signedStakes[0] * 10000) / operatorSetInfo.totalWeights[0];
        uint256 signedPercentage1 = (signedStakes[1] * 10000) / operatorSetInfo.totalWeights[1];
    ...
    function testVerifyCertificateNominal() public {
        ...
        uint256[] memory passThresholds = new uint256[](2);
        ...
        uint256[] memory failThresholds = new uint256[](2);
    ...
    function testMultipleOperatorSets() public {
        ...
        (IBN254TableCalculatorTypes.BN254OperatorInfo[] memory operators1, , ) = 
            createOperatorsWithSplitKeys(111, 3, 1);
        (IBN254TableCalculatorTypes.BN254OperatorInfo[] memory operators2, , ) = 
            createOperatorsWithSplitKeys(222, 2, 2);
        ...
        IBN254TableCalculatorTypes.BN254OperatorSetInfo memory storedInfo1 = 
            verifier.getOperatorSetInfo(operatorSet1, referenceTimestamp);
        IBN254TableCalculatorTypes.BN254OperatorSetInfo memory storedInfo2 = 
            verifier.getOperatorSetInfo(operatorSet2, referenceTimestamp);
