...
abstract contract IntegrationDeployer is ExistingDeploymentParser {
    ...
    function _upgradeMainnetContracts() public virtual {
        ...
        cheats.warp(block.timestamp + 20 days);
        cheats.roll(block.number + 100_000);
        ...
        _deployImplementations(); // update impl vars

        timelockController = TimelockController(payable(0xC06Fd4F821eaC1fF1ae8067b36342899b57BAa2d));
    ...
    function _deployImplementations() public {
        ...
        allocationManagerImplementation = AllocationManager(0xC97602648fA52F92B4ee2b0e5a54Bd15b6cB0345);
        delegationManagerImplementation = DelegationManager(0x6EEd6c2802dF347e05884857CdDB2D3E96D12F89);
        rewardsCoordinatorImplementation = RewardsCoordinator(0xa505c0116aD65071F0130061F94745b7853220aB);
        strategyManagerImplementation = StrategyManager(0x46aefd30415be99e20169eE7046F65784B46d123);
        // permissions
        ...
        // pods
        eigenPodImplementation = EigenPod(payable(0xe2E2dB234b0FFB9AFe41e52dB7d3c2B8585646c3));
        eigenPodManagerImplementation = EigenPodManager(0xE48D7CaeC1790b293667e4bB2dE1E00536F2bABd);
        // strategies
        strategyFactoryImplementation = StrategyFactory(0x1b97d8F963179C0e17E5F3d85cdfd9a31A49bc66);
        eigenStrategyImpl = EigenStrategy(0x530fDB7AdF7d489DF49c27e3d3512c0dD64886be);
        strategyFactoryBeaconImplementation = StrategyBase(0xD4d1746142642Db4c1ab17b03B9c58baac913E5B); // base
        baseStrategyImplementation = StrategyBase(0x62F7226Fb9d615590EadB539713b250fB2fdf4E0); // TVL Limits
    }
