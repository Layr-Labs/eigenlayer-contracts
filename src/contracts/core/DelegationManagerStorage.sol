...
abstract contract DelegationManagerStorage is IDelegationManager {
    ...
    // @notice Mapping: staker => UndelegationLimboStatus struct. Mapping is internal so we can have a getter that returns a memory struct.
    mapping(address => IDelegationManager.UndelegationLimboStatus) internal _stakerUndelegationLimboStatus;
