...
abstract contract StrategyManagerStorage is IStrategyManager {
     ...
     */
    uint256 internal __deprecated_withdrawalDelayBlocks;
    ...
    mapping(bytes32 => bool) public __deprecated_withdrawalRootPending;
    /*
     ...
     */
    mapping(address => uint256) internal __deprecated_numWithdrawalsQueued;
