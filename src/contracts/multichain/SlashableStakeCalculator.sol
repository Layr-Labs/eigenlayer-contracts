...
import {IOperatorWeightCalculator, OperatorSet, OperatorSetLib} from "../interfaces/IOperatorWeightCalculator.sol";
import {SlashableStakeCalculatorStorage, IAllocationManager} from "./SlashableStakeCalculatorStorage.sol";

/**
 * @title SlashableStakeCalculator
 ...
 */
contract SlashableStakeCalculator is Initializable, OwnableUpgradeable, SlashableStakeCalculatorStorage {
    ...
    ) SlashableStakeCalculatorStorage(_allocationManager) {
