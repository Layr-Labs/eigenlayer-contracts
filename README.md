...
| -------- | -------- | -------- | -------- | -------- | 
| Mainnet Ethereum | `v1.13.1` | Yes | Yes | Yes (source & destination) |
| Base | [`v1.9.0`](https://github.com/Layr-Labs/eigenlayer-contracts/releases/tag/v1.9.0) | No | No | Yes (destination) |
| Testnet Sepolia | `v1.13.1` | Yes | No | Yes (source & destination) |
...
| Name | Proxy | Implementation | Notes |
| -------- | -------- | -------- | -------- |
| [`DelegationManager`](https://github.com/Layr-Labs/eigenlayer-contracts/blob/v1.5.0/src/contracts/core/DelegationManager.sol) | [`0xD4A7E1Bd8015057293f0D0A557088c286942e84b`](https://sepolia.etherscan.io/address/0xD4A7E1Bd8015057293f0D0A557088c286942e84b) | [`0xFDFb...18B3`](https://sepolia.etherscan.io/address/0xFDFbBD35C848Ea7907917243035dE9C5d44018B3) | Proxy: [`TUP@4.9.0`](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.0/contracts/proxy/transparent/TransparentUpgradeableProxy.sol) |
